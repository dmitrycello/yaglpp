...
- [GLAD](https://glad.dav1d.de) archive generated with _Specification_ set to **`OpenGL`**, _Profile_ set to **`Core`**, _API_ set to **`gl`** and **`Version 3.3`**. Keep gles1, gles2 and glsc2 as **`None`**. Do not select any extension!
