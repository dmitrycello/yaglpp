...
public:
	...
	{
		_bufferData(_tlsElementArrayBuffer(), GL_ELEMENT_ARRAY_BUFFER, (GLsizeiptr)dataStore.getSize(), dataStore.getData(0), (GLenum)usage);
	}
	...
	{
		_bufferSubData(_tlsElementArrayBuffer(), GL_ELEMENT_ARRAY_BUFFER, offset, size, data.getSubData((int)offset, (int)size));
	}
