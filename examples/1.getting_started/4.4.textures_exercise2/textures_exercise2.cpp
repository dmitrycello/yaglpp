...
int main()
{
    ...
    texture1.textureWrapS = gl::TextureWrapMode::ClampToEdge;  // note that we set the container wrapping method to GL_CLAMP_TO_EDGE
    texture1.textureWrapT = gl::TextureWrapMode::ClampToEdge;
    ...
    texture2.textureWrapS = gl::TextureWrapMode::Repeat; // we want to repeat the awesomeface pattern so we kept it at GL_REPEAT
