...
public:
	...
	/*(2) Specifies a two-dimensional cube map plane's texture image initialized from client's memory. (2.1) Unbinds pixel unpack buffer from its target
	@param Specifies the cube map plane to process
	@param Specifies the level-of-detail number
	@param Specifies the texture internal formats
	...
	/*(2.1) (3) Specifies a two-dimensional cube map plane's texture image initialized from pixel unpack buffer data store
	@param Specifies the pixel unpack buffer used for initialization
	@param Specifies the cube map plane to process
	@param Specifies the level-of-detail number
	@param Specifies the texture internal formats
