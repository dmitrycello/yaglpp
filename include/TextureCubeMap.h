...
public:
	...
	{
		_activeTexture(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, index);
	}
	...
	void bindTexture()
	{
		_texture_rebind(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP);
	}
	...
	void compressedTexImage2D(TextureCubeMapPlane plane, GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei imageSize, _In_ const void* data)
	{
		_compressedTexImage2D(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, (GLenum)internalformat, width, height, imageSize, data);
	}
	...
	static void compressedTexImage2DProxy(GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei imageSize)
	{
	...
	@param Specifies the number of unsigned bytes of image data starting at the specified data address
	@param [in] Specifies a pointer to the compressed image data in memory*/
	void compressedTexSubImage2D(TextureCubeMapPlane plane, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, CompressedTexInternalformat internalformat, GLsizei imageSize, _In_ const void* data)
	{
		_compressedTexSubImage2D(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, xoffset, yoffset, width, height, (GLenum)internalformat, imageSize, data);
	}
	...
	@param Specifies the width of the texture image
	@param Specifies the height of the texture image*/
	void copyTexImage2D(TextureCubeMapPlane plane, GLint level, CopyTexInternalformat internalformat, GLint x, GLint y, GLsizei width, GLsizei height)
	{
		_copyTexImage2D(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, (GLenum)internalformat, x, y, width, height);
	}
	...
	@param Specifies the width of the texture subimage
	@param Specifies the height of the texture subimage*/
	void copyTexSubImage2D(TextureCubeMapPlane plane, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height)
	{
		_copyTexSubImage2D(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, xoffset, yoffset, x, y, width, height);
	}
	...
	{
		_texture_unbind(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP);
	}
	...
	{
		_getCompressedTexImage(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, pixels);
	}
	...
	{
		_getTexImage(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, (GLenum)format, (GLenum)type, pixels);
	}
	...
	{
		return _getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return _getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BASE_LEVEL);
	}
	...
	{
		return _getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		return (CompareFunc)_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_COMPARE_FUNC);
	}
	...
	{
		return _getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		return _getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return _getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return _getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return _getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_HEIGHT);
	}
	...
	{
		return (TexInternalformat)_getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return _getTexParameterFloat(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_LOD_BIAS);
	}
	...
	{
		return (TextureMagFilter)_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MAG_FILTER);
	}
	...
	{
		return _getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MAX_LEVEL);
	}
	...
	{
		return _getTexParameterFloat(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MAX_LOD);
	}
	...
	{
		return (TextureMinFilter)_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MIN_FILTER);
	}
	...
	{
		return _getTexParameterFloat(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MIN_LOD);
	}
	...
	{
		return _getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return _getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_WIDTH);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_WRAP_R);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_WRAP_S);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_WRAP_T);
	}
	...
	{
		return _object_id() == _getInteger(GL_TEXTURE_BINDING_CUBE_MAP);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BASE_LEVEL, level);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_COMPARE_FUNC, (GLint)func);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_LOD_BIAS, bias);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MAX_LEVEL, maxlevel);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MAX_LOD, maxlod);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MIN_FILTER, (GLint)filter);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MIN_LOD, minlod);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_WRAP_R, (GLint)wrap);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_WRAP_S, (GLint)wrap);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_WRAP_T, (GLint)wrap);
	}
	...
	void texImage2D(StbImage& image, TextureCubeMapPlane plane, GLint level, TexInternalformat internalformat)
	{
		_texImage2D(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, (GLint)internalformat, image);
	}
	...
	void texImage2D(TextureCubeMapPlane plane, GLint level, TexInternalformat internalformat, GLsizei width, GLsizei height, TexFormat format, TexType type, _In_ const void* data)
	{
		_texImage2D(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, (GLint)internalformat, width, height, (GLenum)format, (GLenum)type, data);
	}
	...
	@param Specifies a texel offset in the x direction within the texture array
	@param Specifies a texel offset in the y direction within the texture array*/
	void texSubImage2D(StbImage& image, TextureCubeMapPlane plane, GLint level, GLint xoffset, GLint yoffset)
	{
		_texSubImage2D(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, xoffset, yoffset, image);
	}
	...
	@param Specifies the data type of the pixel data
	@param [in] Specifies a pointer to the image data in memory*/
	void texSubImage2D(TextureCubeMapPlane plane, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, TexSubFormat format, TexSubType type, _In_ const void* pixels)
	{
		_texSubImage2D(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, xoffset, yoffset, width, height, (GLenum)format, (GLenum)type, pixels);
	}
	...
	/*Read-only property to determine if the texture object is currently bound to its target*/
	...
	/*Read-write property for mode of the texture compression hint*/
	...
	void compressedTexImage2D(PixelUnpackBuffer& buffer, TextureCubeMapPlane plane, GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei imageSize, GLintptr offset)
	{
		_compressedTexImage2D(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, (GLenum)internalformat, width, height, imageSize, (_Buffer&)buffer, offset);
	}
	...
	@param Specifies the number of unsigned bytes of image data starting at the specified data offset into PBO data store
	@param Specifies the byte offset into PBO data store*/
	void compressedTexSubImage2D(PixelUnpackBuffer& buffer, TextureCubeMapPlane plane, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, CompressedTexInternalformat internalformat, GLsizei imageSize, GLintptr offset)
	{
		_compressedTexSubImage2D(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, xoffset, yoffset, width, height, (GLenum)internalformat, imageSize, (_Buffer&)buffer, offset);
	}
	...
	{
		_getCompressedTexImage(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, (_Buffer&)buffer, offset);
	}
	...
	{
		_getTexImage(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}
	...
	@param Specifies the data type of the pixel data
	@param Specifies the byte offset into PBO data store*/
	void texSubImage2D(PixelUnpackBuffer& buffer, TextureCubeMapPlane plane, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, TexSubFormat format, TexSubType type, GLintptr offset)
	{
		_texSubImage2D(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, xoffset, yoffset, width, height, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}
	...
	void generateMipmap()
	{
		_generateMipmap(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return (TextureCompareMode)_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_COMPARE_MODE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_COMPARE_MODE, (GLint)mode);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_SWIZZLE_A);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_SWIZZLE_B);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_SWIZZLE_G);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_SWIZZLE_R);
	}
	...
	{
		_getTexParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_SWIZZLE_RGBA, (GLint*)swizzle);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_SWIZZLE_A, (GLint)swizzle);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_SWIZZLE_B, (GLint)swizzle);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_SWIZZLE_G, (GLint)swizzle);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_SWIZZLE_R, (GLint)swizzle);
	}
	...
	{
		_texParameter(_tlsTextureCubeMap(), GL_TEXTURE_CUBE_MAP, GL_TEXTURE_SWIZZLE_RGBA, (const GLint*)swizzle);
	}
