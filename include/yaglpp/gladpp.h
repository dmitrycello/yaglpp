...
#include <glad/3.2/glad.h>
#elif (YAGLPP_CONTEXT_VERSION_MAJOR == 3) && (YAGLPP_CONTEXT_VERSION_MINOR == 1)
#include <glad/3.1/glad.h>
#elif (YAGLPP_CONTEXT_VERSION_MAJOR == 3) && (YAGLPP_CONTEXT_VERSION_MINOR == 0)
#include <glad/3.0/glad.h>
#elif (YAGLPP_CONTEXT_VERSION_MAJOR == 2) && (YAGLPP_CONTEXT_VERSION_MINOR == 1)
#include <glad/2.1/glad.h>
#elif (YAGLPP_CONTEXT_VERSION_MAJOR == 2) && (YAGLPP_CONTEXT_VERSION_MINOR == 0)
#include <glad/2.0/glad.h>
#else
#error YAGL++ requires OpenGL context version 2.0, 2.1, 3.0, 3.1, 3.2 or 3.3
#endif
/*(1) The GLAD loader to be ported into another library with an extern declaration. Pprefered version for SFML and GLEW
...
@param Specifies the red value used when the color buffers are cleared. The initial values is 0.0
@param Specifies the green value used when the color buffers are cleared. The initial values is 0.0
@param Specifies the blue value used when the color buffers are cleared. The initial values is 0.0
@param Specifies the alpha value used when the color buffers are cleared. The initial values is 0.0*/
...
#if defined (GL_VERSION_3_1) && defined (YAGLPP_INLINE_IMPLEMENTATION)
...
#endif // #if defined (GL_VERSION_3_1) && defined (YAGLPP_INLINE_IMPLEMENTATION)
...
#if defined (GL_VERSION_3_2) && defined (YAGLPP_DEBUG_IMPLEMENTATION)
GLint64 _getInteger64(GLenum pname)
{
	GLint64 iData64;
...
#endif // #if defined (GL_VERSION_3_2) && defined (YAGLPP_DEBUG_IMPLEMENTATION)

#if defined (GL_VERSION_3_2) && defined (YAGLPP_INLINE_IMPLEMENTATION)
...
#endif // #if defined (GL_VERSION_3_2) && defined (YAGLPP_INLINE_IMPLEMENTATION)
