...
public:
	...
	{
		return _object_id() == (GLuint)_getInteger(GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY);
	}
	...
	{
		_setTextureBinding(GL_TEXTURE_2D_MULTISAMPLE_ARRAY, GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY, bind);
	}
