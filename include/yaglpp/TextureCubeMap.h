...
public:
	...
	TextureCubeMap(Textures& textures, GLuint index)
	{
	...
	{
#ifdef _DEBUG
		_object_assign((_Objects&)textures, index, GL_TEXTURE_CUBE_MAP);
#else // #ifdef _DEBUG
	...
	{
		_setTextureBinding(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, bind);
	}
	...
	void shareTexture(TextureCubeMap& texture)
	{
