...
public:
	...
	/*(3.2) Gets the current synchronization object, or null if empty object
	@return The OpenGL object name*/
	_Ret_maybenull_ GLsync Get() const
	{
		return m_Sync;
	}
	...
	/*(3.2) Checks if not an empty synchronization object. MSVC getter for <object> property
	@return True if not an empty synchronization object, false otherwise*/
	...
	/*(3.2) Read-only property to check if not an empty synchronization object*/
