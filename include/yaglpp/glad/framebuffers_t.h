...
#ifndef YAGLPP_FRAMEBUFFERS_T_H
#define YAGLPP_FRAMEBUFFERS_T_H

namespace gl {
#ifdef YAGLPP_VERSION_3_0
template <GLenum T, GLenum B> class Framebuffers_1 : public Framebuffers
{
public:
	...
	{
		Framebuffers::framebuffer_renderbuffer(T, B, (GLenum)attachment, renderbuffer.Get());
	}
	...
	{
		Framebuffers::framebuffer_texture_1d(T, B, (GLenum)attachment, texture.Get(), level);
	}
	...
	{
		Framebuffers::framebuffer_texture_2d(T, B, (GLenum)attachment, texture.Get(), GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level);
	}
	...
	{
		Framebuffers::framebuffer_texture_3d(T, B, (GLenum)attachment, texture.Get(), level, layer);
	}
	...
	{
		Framebuffers::framebuffer_texture_2d(T, B, (GLenum)attachment, texture.Get(), (GLenum)plane, GL_TEXTURE_BINDING_CUBE_MAP, level);
	}
	...
	{
		Framebuffers::framebuffer_texture_layer(T, B, (GLenum)attachment, texture.Get(), GL_TEXTURE_BINDING_1D_ARRAY, level, layer);
	}
	...
	{
		Framebuffers::framebuffer_texture_layer(T, B, (GLenum)attachment, texture.Get(), GL_TEXTURE_BINDING_2D_ARRAY, level, layer);
	}

	/*(3.0) Binds framebuffer object to its target. Does nothing if specified object is bound*/
	void Bind()
	{
		Objects::object_bind(glBindFramebuffer, T);
	}
	...
	{
		Framebuffers::blit_framebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, Get(), Get(), (GLenum)mask, (GLenum)filter);
	}
	...
	{
		return (CompletenessStatus)Framebuffers::check_framebuffer_status(T, B);
	}
	...
	{
		Framebuffers::framebuffer_renderbuffer(T, B, (GLenum)attachment, 0);
	}
	...
	void GenBind()
	{
		Objects::object_gen_bind(glGenFramebuffers, glBindFramebuffer, T);
	}
	...
	{
		return (AttachmentType)Framebuffers::get_framebuffer_attachment_parameter(T, B, (GLenum)attachment, GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE);
	}
	...
	{
		return Framebuffers::get_framebuffer_attachment_parameter(T, B, (GLenum)attachment, GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL);
	}
	...
	{
		Framebuffers::framebuffer_texture_2d(T, B, (GLenum)attachment, texture.Get(), GL_TEXTURE_RECTANGLE, GL_TEXTURE_BINDING_RECTANGLE, 0);
	}
	...
	{
		Framebuffers::framebuffer_texture_2d(T, B, (GLenum)attachment, texture.Get(), GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0);
	}
	...
	{
		Framebuffers::framebuffer_texture_layer(T, B, (GLenum)attachment, texture.Get(), GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY, 0, layer);
	}
	...
	{
		return Framebuffers::get_framebuffer_attachment_parameter(T, B, (GLenum)attachment, GL_FRAMEBUFFER_ATTACHMENT_LAYERED);
	}
#endif // #ifdef YAGLPP_VERSION_3_2
}; // template <GLenum T, GLenum B> class Framebuffers_1 : public Framebuffers

typedef Framebuffers_1<GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING> DrawFramebuffer_1;
/*(3.0) OpenGL draw framebuffer object class derived from <Framebuffers>*/
class DrawFramebuffer : public DrawFramebuffer_1
{
public:
	using Framebuffers_1::Framebuffers_1;
	...
	@param The bitwise OR of the mask flags indicating which buffers are to be copied
	@param Specifies the interpolation to be applied if the image is stretched*/
	void Blit(ReadFramebuffer& read, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, BufferBit mask, Textures::MagFilter filter)
	{
		Framebuffers::blit_framebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, ((Framebuffers&)read).Get(), Get(), (GLenum)mask, (GLenum)filter);
	}
	...
	static DrawFramebuffer GetBinding()
	{
		return DrawFramebuffer(yaglpp_glad_integer(GL_DRAW_FRAMEBUFFER_BINDING));
	}
};

typedef Framebuffers_1<GL_FRAMEBUFFER, GL_FRAMEBUFFER_BINDING> Framebuffer_1;
/*(3.0) OpenGL dual framebuffer object class derived from <Framebuffers>*/
class Framebuffer : public Framebuffer_1
{
public:
	using Framebuffers_1::Framebuffers_1;
	/*(3.0) Transfer a rectangle of pixel values from one region to another within the same dual framebuffer
...
typedef Framebuffers_1<GL_READ_FRAMEBUFFER, GL_READ_FRAMEBUFFER_BINDING> ReadFramebuffer_1;
/*(3.0) OpenGL read framebuffer object class derived from <Framebuffers>*/
class ReadFramebuffer : public ReadFramebuffer_1
{
public:
	using Framebuffers_1::Framebuffers_1;
	/*(3.0) Transfer a rectangle of pixel values from one region of a read framebuffer to another region of a draw framebuffer
	...
	@param The bitwise OR of the mask flags indicating which buffers are to be copied
	@param Specifies the interpolation to be applied if the image is stretched*/
	void Blit(DrawFramebuffer& draw, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, BufferBit mask, Textures::MagFilter filter)
	{
		Framebuffers::blit_framebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, Get(), ((Framebuffers&)draw).Get(), (GLenum)mask, (GLenum)filter);
	}

	/*(3.0) Returns the framebuffer object currently bound to particular target
	@return The bound framebuffer object, or empty object*/
	static ReadFramebuffer GetBinding()
	{
		return ReadFramebuffer(yaglpp_glad_integer(GL_READ_FRAMEBUFFER_BINDING));
	}
};
#endif // #ifdef YAGLPP_VERSION_3_0
} // namespace gl
#endif // #ifndef YAGLPP_FRAMEBUFFERS_T_H
