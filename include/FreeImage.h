...
public:
	...
	/*Return FreeImage object page count. Used as a getter of <pageCount> property
	@return The number of image pages in the FreeImage object*/
	int getPageCount() const;

	/*Check if FreeImage object contains one or more images. Used as a getter of <freeImage> property
	@return True if FreeImage object contains images, false otherwise*/
	bool isFreeImage() const
	{
	...
	/*Read-only property for index of largest image page in the object*/
	__declspec(property(get = getPageCount)) int pageCount;

	/*Read-only property to check if FreeImage object contains one or more images*/
	__declspec(property(get = isFreeImage)) bool freeImage;
