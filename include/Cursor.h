...
public:
	...
	/*(M) (4) Creates a new custom cursor image object that can be set to a window
	...
	/*(M) (5) Creates a new custom cursor image object that can be set to a window
