...
#include <glad/glad30.h>
#elif (GLPP_CONTEXT_VERSION_MAJOR == 2) && (GLPP_CONTEXT_VERSION_MINOR == 1)
#include <glad/glad21.h>
#elif (GLPP_CONTEXT_VERSION_MAJOR == 2) && (GLPP_CONTEXT_VERSION_MINOR == 0)
#include <glad/glad20.h>
#else
#error GLAD++: OpenGL context version 2.0, 2.1, 3.0, 3.1, 3.2 or 3.3 required
#endif

/*glpp GLAD library namespace*/
namespace gl {
...
#else // #ifndef _DEBUG
/*glpp GLAD error checking macro, does nothing in Release mode*/
#define GLPP_GLAD_ERROR GLPP_ASSERT(_getError())
#endif // #ifndef _DEBUG
