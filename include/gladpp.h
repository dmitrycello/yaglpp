...
#pragma message ("YAGL++: Implementation compiling with OpenGL " YAGLPP_XSTR(YAGLPP_CONTEXT_VERSION_MAJOR) "." YAGLPP_XSTR(YAGLPP_CONTEXT_VERSION_MINOR) " context version support...")
#else // #ifdef YAGLPP_IMPLEMENTATION
