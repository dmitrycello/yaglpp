...
public:
	...
	SamplesPassed& getSamplesPassed(GLuint index)
	{
	...
	@param Specifies the object name index*/
	PrimitivesGenerated& getPrimitivesGenerated(GLuint index)
	{
	...
	@param Specifies the object name index*/
	TransformFeedbackPrimitivesWritten& getTransformFeedbackPrimitivesWritten(GLuint index)
	{
	...
	@param Specifies the object name index*/
	AnySamplesPassed& getAnySamplesPassed(GLuint index)
	{
	...
	@param Specifies the object name index*/
	TimeElapsed& getTimeElapsed(GLuint index)
	{
