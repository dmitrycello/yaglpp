...
{
public:
	/*(1) Constructs an empty shader object*/
	VertexShader() {}
	...
	/*(4) Constructs shader object from file*/
	VertexShader(_In_z_ const char* filepath)
	{
		_shaderSource(GL_VERTEX_SHADER, filepath);
	}

	/*(5) Constructs shader object from strings containing the source*/
	...
	/*Determines the shader object type parameter. Used as a getter of <getShaderType> property
	...
	{
		_setShader(GL_VERTEX_SHADER, gen);
	}
