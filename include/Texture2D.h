...
public:
	...
	void bindTexture()
	{
		_texture_rebind(_tlsTexture2D(), GL_TEXTURE_2D);
	}
	...
	void compressedTexImage2D(GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei imageSize, _In_ const void* data)
	{
		_compressedTexImage2D(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, (GLenum)internalformat, width, height, imageSize, data);
	}
	...
	@param Specifies the number of unsigned bytes of image data starting at the specified data address
	@param [in] Specifies a pointer to the compressed image data in memory*/
	void compressedTexSubImage2D(GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, CompressedTexInternalformat internalformat, GLsizei imageSize, _In_ const void* data)
	{
		_compressedTexSubImage2D(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, xoffset, yoffset, width, height, (GLenum)internalformat, imageSize, data);
	}
	...
	@param Specifies the width of the texture image
	@param Specifies the height of the texture image*/
	void copyTexImage2D(GLint level, CopyTexInternalformat internalformat, GLint x, GLint y, GLsizei width, GLsizei height)
	{
		_copyTexImage2D(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, (GLenum)internalformat, x, y, width, height);
	}
	...
	{
		_copyTexSubImage2D(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, xoffset, yoffset, x, y, width, height);
	}
	...
	{
		_texture_unbind(_tlsTexture2D(), GL_TEXTURE_2D);
	}
	...
	{
		_getCompressedTexImage(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, pixels);
	}
	...
	{
		_getTexImage(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, (GLenum)format, (GLenum)type, pixels);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return _getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_BASE_LEVEL);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		return (CompareFunc)_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_COMPARE_FUNC);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	/*Gets a value indicating the mode of the texture compression hint. Used as the getter of <textureCompressionHint> property
	...
	{
		return _getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_HEIGHT);
	}
	...
	{
		return (TexInternalformat)_getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return _getTexParameterFloat(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_LOD_BIAS);
	}
	...
	{
		return (TextureMagFilter)_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER);
	}
	...
	{
		return _getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_MAX_LEVEL);
	}
	...
	{
		return _getTexParameterFloat(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_MAX_LOD);
	}
	...
	{
		return (TextureMinFilter)_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER);
	}
	...
	{
		return _getTexParameterFloat(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_MIN_LOD);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_WIDTH);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_WRAP_R);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_WRAP_S);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_WRAP_T);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_BASE_LEVEL, level);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_COMPARE_FUNC, (GLint)func);
	}

	/*Indicates the quality and performance of the compressing texture images. Hinting <Fastest> indicates that texture images should be compressed as quickly as possible, while <Nicest> indicates that texture images should be compressed with as little image quality loss as possible. Used as the setter of <textureCompressionHint> property
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_LOD_BIAS, bias);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_MAX_LEVEL, maxlevel);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_MAX_LOD, maxlod);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, (GLint)filter);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_MIN_LOD, minlod);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_WRAP_R, (GLint)wrap);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, (GLint)wrap);
	}
	...
	{
		_texImage2D(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, (GLint)internalformat, image);
	}

	/*(2) Specifies a two-dimensional texture image initialized from client's memory. (2.1) Unbinds pixel unpack buffer from its target
	@param Specifies the level-of-detail number
	@param Specifies the texture internal formats
	...
	{
		_texImage2D(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, (GLint)internalformat, width, height, (GLenum)format, (GLenum)type, data);
	}
	...
	{
		_texSubImage2D(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, xoffset, yoffset, image);
	}
	...
	@param Specifies the data type of the pixel data
	@param [in] Specifies a pointer to the image data in memory*/
	void texSubImage2D(GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, TexSubFormat format, TexSubType type, _In_ const void* pixels)
	{
		_texSubImage2D(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, xoffset, yoffset, width, height, (GLenum)format, (GLenum)type, pixels);
	}
	...
	void compressedTexImage2D(PixelUnpackBuffer& buffer, GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei imageSize, GLintptr offset)
	{
		_compressedTexImage2D(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, (GLenum)internalformat, width, height, imageSize, (_Buffer&)buffer, offset);
	}
	...
	@param Specifies the number of unsigned bytes of image data starting at the specified data offset into PBO data store
	@param Specifies the byte offset into PBO data store*/
	void compressedTexSubImage2D(PixelUnpackBuffer& buffer, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, CompressedTexInternalformat internalformat, GLsizei imageSize, GLintptr offset)
	{
		_compressedTexSubImage2D(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, xoffset, yoffset, width, height, (GLenum)internalformat, imageSize, (_Buffer&)buffer, offset);
	}
	...
	{
		_getCompressedTexImage(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, (_Buffer&)buffer, offset);
	}
	...
	{
		_getTexImage(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}
	...
	{
		_texImage2D(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, (GLint)internalformat, width, height, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}
	...
	@param Specifies the data type of the pixel data
	@param Specifies the byte offset into PBO data store*/
	void texSubImage2D(PixelUnpackBuffer& buffer, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, TexSubFormat format, TexSubType type, GLintptr offset)
	{
		_texSubImage2D(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, xoffset, yoffset, width, height, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}
	...
	void generateMipmap()
	{
		_generateMipmap(_tlsTexture2D(), GL_TEXTURE_2D);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return (TextureCompareMode)_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_COMPARE_MODE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_2D, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_COMPARE_MODE, (GLint)mode);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_SWIZZLE_A);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_SWIZZLE_B);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_SWIZZLE_G);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_SWIZZLE_R);
	}
	...
	{
		_getTexParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_SWIZZLE_RGBA, (GLint*)swizzle);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_SWIZZLE_A, (GLint)swizzle);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_SWIZZLE_B, (GLint)swizzle);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_SWIZZLE_G, (GLint)swizzle);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_SWIZZLE_R, (GLint)swizzle);
	}
	...
	{
		_texParameter(_tlsTexture2D(), GL_TEXTURE_2D, GL_TEXTURE_SWIZZLE_RGBA, (const GLint*)swizzle);
	}
