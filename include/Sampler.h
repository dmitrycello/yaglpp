...
public:
	...
	/*(3.3) Returns the current texture comparison function. Used as the getter of <textureCompareFunc> property
	@param The index of the object name, default 0
	...
	/*(3.3) Gets the texture comparison mode for currently bound depth textures. Used as the getter of <textureCompareMode> property
	...
	/*(3.3) Returns the current fixed level-of-detail bias value. Used as the getter of <textureLodBias> property
	...
	/*(3.3) Gets the current texture magnification function. Used as the getter of <textureMagFilter> property
	...
	/*(3.3) Returns the current texture maximum level-of-detail value. Used as the getter of <textureMaxLod> property
	...
	/*(3.3) Gets the current texture minifying function. Used as the getter of <textureMinFilter> property
	...
	/*(3.3) Returns the current texture minimum level-of-detail value. Used as the getter of <textureMinLod> property
	...
	/*(3.3) Returns the wrapping function for texture coordinate r. Used as the getter of <textureWrapR> property
	...
	/*(3.3) Returns the wrapping function for texture coordinate s. Used as the getter of <textureWrapS> property
	...
	/*(3.3) Returns the wrapping function for texture coordinate t. Used as the getter of <textureWrapT> property
	...
	/*(3.3) Specifies the comparison operator used when texture compare mode flag is set. Used as the setter of <textureCompareFunc> property
	...
	/*(3.3) Specifies the texture comparison mode flag for currently bound depth textures. Used as the setter of <textureCompareMode> property
	...
	/*(3.3) Specifies a fixed bias value that is to be added to the level-of-detail parameter for the texture before texture sampling. Used as the setter of <textureLodBias> property
	...
	/*(3.3) The texture magnification function is used whenever the level-of-detail function used when sampling from the texture determines that the texture should be magified. Used as the setter of <textureMagFilter> property
	...
	/*(3.3) Sets the maximum level-of-detail value that limits the selection of the lowest resolution mipmap. Used as the setter of <textureMaxLod> property
	...
	/*(3.3) The texture minifying function is used whenever the level-of-detail function used when sampling from the texture determines that the texture should be minified. Used as the setter of <textureMinFilter> property
	...
	/*(3.3) Sets the minimum level-of-detail value that limits the selection of the highest resolution mipmap. Used as the setter of <textureMinLod> property
	...
	/*(3.3) Sets the wrapping function for texture coordinate r. Used as the setter of <textureWrapR> property
	...
	/*(3.3) Sets the wrapping function for texture coordinate s. Used as the setter of <textureWrapS> property
	...
	/*(3.3) Sets the wrapping function for texture coordinate t. Used as the setter of <textureWrapT> property
