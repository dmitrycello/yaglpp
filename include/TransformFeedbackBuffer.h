...
public:
	...
	void bindBuffer()
	{
		_bindBuffer(GL_TRANSFORM_FEEDBACK_BUFFER, GL_TRANSFORM_FEEDBACK_BUFFER_BINDING);
	}
	...
	{
		_bufferData(GL_TRANSFORM_FEEDBACK_BUFFER, GL_TRANSFORM_FEEDBACK_BUFFER_BINDING, (GLsizeiptr)dataStore.getSize(), dataStore.getData(), (GLenum)usage);
	}
	...
	{
		_bufferData(GL_TRANSFORM_FEEDBACK_BUFFER, GL_TRANSFORM_FEEDBACK_BUFFER_BINDING, size, data, (GLenum)usage);
	}
	...
	{
		_bufferSubData(GL_TRANSFORM_FEEDBACK_BUFFER, GL_TRANSFORM_FEEDBACK_BUFFER_BINDING, 0, data.getSize(), data.getData());
	}
	...
	{
		_bufferSubData(GL_TRANSFORM_FEEDBACK_BUFFER, GL_TRANSFORM_FEEDBACK_BUFFER_BINDING, offset, size, data.getSubData((int)offset, (int)size));
	}
	...
	{
		_getBufferSubData(GL_TRANSFORM_FEEDBACK_BUFFER, GL_TRANSFORM_FEEDBACK_BUFFER_BINDING, offset, size, data.getSubData((int)offset, (int)size));
	}
	...
	{
		return _object_id() == (GLuint)_getInteger(GL_TRANSFORM_FEEDBACK_BUFFER_BINDING);
	}
	...
	{
		_setBufferBinding(GL_TRANSFORM_FEEDBACK_BUFFER, GL_TRANSFORM_FEEDBACK_BUFFER_BINDING, bind);
	}
