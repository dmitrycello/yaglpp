...
public:
	...
	{
		_bufferData(GL_TEXTURE_BUFFER, GL_TEXTURE_BUFFER_BINDING, (GLsizeiptr)dataStore.getSize(), dataStore.getData(), (GLenum)usage);
	}
	...
	{
		_bufferSubData(GL_TEXTURE_BUFFER, GL_TEXTURE_BUFFER_BINDING, 0, data.getSize(), data.getData());
	}
	...
	{
		_bufferSubData(GL_TEXTURE_BUFFER, GL_TEXTURE_BUFFER_BINDING, offset, size, data.getSubData((int)offset, (int)size));
	}
	...
	{
		_getBufferSubData(GL_TEXTURE_BUFFER, GL_TEXTURE_BUFFER_BINDING, offset, size, data.getSubData((int)offset, (int)size));
	}
	...
	{
		_setBufferBinding(GL_TEXTURE_BUFFER, GL_TEXTURE_BUFFER_BINDING, bind);
	}
