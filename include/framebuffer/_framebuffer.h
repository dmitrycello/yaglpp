...
public:
	...
	Framebuffer& getFramebuffer(GLuint index)
	{
	...
	@param Specifies the object name index*/
	ReadFramebuffer& getReadFramebuffer(GLuint index)
	{
	...
	@param Specifies the object name index*/
	DrawFramebuffer& getDrawFramebuffer(GLuint index)
	{
...
void _Framebuffer::_bindFramebuffer(GLenum target, GLenum binding)
{
	...
	if (uId != _framebufferBinding(binding))
	{
...
{
	if (_object_id() == _framebufferBinding(binding))
	{
