...
public:
	...
	{
		bindFramebuffer();
		_blitFramebuffer((_Framebuffer&)dst, GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
	}
	...
	{
		_setFramebufferBinding(GL_READ_FRAMEBUFFER, GL_READ_FRAMEBUFFER_BINDING, bind);
	}
