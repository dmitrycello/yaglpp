...
public:
	...
	/*(3.0) Explicitly binds framebuffer object to its target, this also unbinds read framebuffer and draw framebuffer binding. Does nothing if specified buffer is bound*/
	...
	{
		return _object_id() == (GLuint)_getInteger(GL_READ_FRAMEBUFFER_BINDING);
	}
	...
	{
		_setFramebufferBinding(GL_FRAMEBUFFER, GL_FRAMEBUFFER_BINDING, bind);
	}
