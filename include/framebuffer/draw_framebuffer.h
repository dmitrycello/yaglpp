...
#ifndef YAGLPP_DRAW_FRAMEBUFFER_H
#define YAGLPP_DRAW_FRAMEBUFFER_H

#ifdef YAGLPP_VERSION_3_0
namespace gl {
/*(3.0) OpenGL draw framebuffer object class derived from <Framebuffers>*/
class DrawFramebuffer : public Framebuffers
{
public:
	...
	{
		framebuffer_renderbuffer(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, renderbuffer.Get());
	}
	...
	{
		framebuffer_texture_1d(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, texture.Get(), level);
	}
	...
	{
		framebuffer_texture_2d(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, texture.Get(), GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level);
	}
	...
	{
		framebuffer_texture_3d(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, texture.Get(), level, layer);
	}
	...
	{
		framebuffer_texture_2d(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, texture.Get(), (GLenum)plane, GL_TEXTURE_BINDING_CUBE_MAP, level);
	}
	...
	{
		framebuffer_texture_layer(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, texture.Get(), GL_TEXTURE_BINDING_1D_ARRAY, level, layer);
	}
	...
	{
		framebuffer_texture_layer(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, texture.Get(), GL_TEXTURE_BINDING_2D_ARRAY, level, layer);
	}

	/*(3.0) Binds framebuffer object to its target. Does nothing if specified object is bound*/
	void Bind()
	{
		object_bind(glBindFramebuffer, GL_DRAW_FRAMEBUFFER);
	}
	...
	{
		blit_framebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, ((Framebuffers&)read).Get(), Get(), (GLenum)mask, (GLenum)filter);
	}
	...
	{
		return (CompletenessStatus)check_framebuffer_status(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING);
	}
	...
	{
		framebuffer_renderbuffer(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, 0);
	}
	...
	void GenBind()
	{
		object_gen_bind(glGenFramebuffers, glBindFramebuffer, GL_DRAW_FRAMEBUFFER);
	}
	...
	{
		return (AttachmentType)get_framebuffer_attachment_parameter(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE);
	}
	...
	{
		return get_framebuffer_attachment_parameter(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL);
	}
	...
	{
		return object_binding(GL_DRAW_FRAMEBUFFER_BINDING, Get());
	}
	...
	{
		framebuffer_texture_2d(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, texture.Get(), GL_TEXTURE_RECTANGLE, GL_TEXTURE_BINDING_RECTANGLE, 0);
	}
	...
	{
		framebuffer_texture_2d(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, texture.Get(), GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0);
	}
	...
	{
		framebuffer_texture_layer(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, texture.Get(), GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY, 0, layer);
	}
	...
	{
		return get_framebuffer_attachment_parameter(GL_DRAW_FRAMEBUFFER, GL_DRAW_FRAMEBUFFER_BINDING, (GLenum)attachment, GL_FRAMEBUFFER_ATTACHMENT_LAYERED);
	}
#endif // #ifdef YAGLPP_VERSION_3_2
}; // class DrawFramebuffer : public Framebuffers
} // namespace gl
#endif // #ifdef YAGLPP_VERSION_3_0
#endif // #ifndef YAGLPP_DRAW_FRAMEBUFFER_H
