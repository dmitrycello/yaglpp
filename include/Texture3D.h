...
public:
	...
	Texture3D(Textures& textures, GLuint index)
	{
	...
	{
		_activeTexture(_tlsTexture3D(), GL_TEXTURE_3D, index);
	}
	...
	{
#ifdef _DEBUG
		_object_assign((_Objects&)textures, index, GL_TEXTURE_3D);
#else // #ifdef _DEBUG
	...
	void bindTexture()
	{
		_texture_rebind(_tlsTexture3D(), GL_TEXTURE_3D);
	}
	...
	void compressedTexImage3D(GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei depth, GLsizei imageSize, _In_ const void* data)
	{
		_compressedTexImage3D(_tlsTexture3D(), GL_TEXTURE_3D, level, (GLenum)internalformat, width, height, depth, imageSize, data);
	}
	...
	static void compressedTexImage3DProxy(GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei depth, GLsizei imageSize)
	{
	...
	@param Specifies the number of unsigned bytes of image data starting at the specified data address
	@param [in] Specifies a pointer to the compressed image data in memory*/
	void compressedTexSubImage3D(GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, CompressedTexInternalformat internalformat, GLsizei imageSize, _In_ const void* data)
	{
		_compressedTexSubImage3D(_tlsTexture3D(), GL_TEXTURE_3D, level, xoffset, yoffset, zoffset, width, height, depth, (GLenum)internalformat, imageSize, data);
	}
	...
	{
		_copyTexSubImage3D(_tlsTexture3D(), GL_TEXTURE_3D, level, xoffset, yoffset, zoffset, x, y, width, height);
	}
	...
	{
		_texture_unbind(_tlsTexture3D(), GL_TEXTURE_3D);
	}
	...
	{
		_getCompressedTexImage(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, pixels);
	}
	...
	{
		_getTexImage(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, (GLenum)format, (GLenum)type, pixels);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return _getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_BASE_LEVEL);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		return (CompareFunc)_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_COMPARE_FUNC);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_DEPTH);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_HEIGHT);
	}
	...
	{
		return (TexInternalformat)_getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return _getTexParameterFloat(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_LOD_BIAS);
	}
	...
	{
		return (TextureMagFilter)_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_MAG_FILTER);
	}
	...
	{
		return _getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_MAX_LEVEL);
	}
	...
	{
		return _getTexParameterFloat(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_MAX_LOD);
	}
	...
	{
		return (TextureMinFilter)_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_MIN_FILTER);
	}
	...
	{
		return _getTexParameterFloat(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_MIN_LOD);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return _getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_WIDTH);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_WRAP_R);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_WRAP_S);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_WRAP_T);
	}
	...
	{
		return _object_id() == _getInteger(GL_TEXTURE_BINDING_3D);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_BASE_LEVEL, level);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_COMPARE_FUNC, (GLint)func);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_LOD_BIAS, bias);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_MAX_LEVEL, maxlevel);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_MAX_LOD, maxlod);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_MIN_FILTER, (GLint)filter);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_MIN_LOD, minlod);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_WRAP_R, (GLint)wrap);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_WRAP_S, (GLint)wrap);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_WRAP_T, (GLint)wrap);
	}
	...
	void shareTexture(Texture3D& texture)
	{
	...
	{
		_texImage3D(_tlsTexture3D(), GL_TEXTURE_3D, level, (GLint)internalformat, layers, image);
	}

	/*(2) Specifies a three-dimensional texture image initialized from client's memory. (2.1) Unbinds pixel unpack buffer from its target
	@param Specifies the level-of-detail number
	@param Specifies the texture internal formats
	@param Specifies the width of the texture image. Supports images that are at least 16 texels wide
	...
	void texImage3D(GLint level, TexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei depth, TexFormat format, TexType type, _In_ const void* data)
	{
		_texImage3D(_tlsTexture3D(), GL_TEXTURE_3D, level, (GLint)internalformat, width, height, depth, (GLenum)format, (GLenum)type, data);
	}
	...
	@param Specifies the format of the pixel data
	@param Specifies the data type of the pixel data*/
	static void texImage3DProxy(GLint level, TexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei depth, TexFormat format, TexType type)
	{
	...
	{
		_texSubImage3D(_tlsTexture3D(), GL_TEXTURE_3D, level, xoffset, yoffset, zoffset, layers, image);
	}
	...
	@param Specifies the data type of the pixel data
	@param [in] Specifies a pointer to the image data in memory*/
	void texSubImage3D(GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, TexSubFormat format, TexSubType type, _In_ const void* pixels)
	{
		_texSubImage3D(_tlsTexture3D(), GL_TEXTURE_3D, level, xoffset, yoffset, zoffset, width, height, depth, (GLenum)format, (GLenum)type, pixels);
	}
	...
	void compressedTexImage3D(PixelUnpackBuffer& buffer, GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei depth, GLsizei imageSize, GLintptr offset)
	{
		_compressedTexImage3D(_tlsTexture3D(), GL_TEXTURE_3D, level, (GLenum)internalformat, width, height, depth, imageSize, (_Buffer&)buffer, offset);
	}
	...
	{
		_compressedTexSubImage3D(_tlsTexture3D(), GL_TEXTURE_3D, level, xoffset, yoffset, zoffset, width, height, depth, (GLenum)internalformat, imageSize, (_Buffer&)buffer, offset);
	}
	...
	{
		_getCompressedTexImage(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, (_Buffer&)buffer, offset);
	}
	...
	{
		_getTexImage(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}

	/*(2.1) (3) Specifies a three-dimensional texture image initialized from pixel unpack buffer data store
	@param Specifies the pixel unpack buffer used for initialization
	@param Specifies the level-of-detail number
	@param Specifies the texture internal formats
	@param Specifies the width of the texture image. Supports images that are at least 16 texels wide
	...
	@param Specifies the data type of the pixel data
	@param Specifies the byte offset into PBO data store*/
	void texImage3D(PixelUnpackBuffer& buffer, GLint level, TexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei depth, TexFormat format, TexType type, GLintptr offset)
	{
		_texImage3D(_tlsTexture3D(), GL_TEXTURE_3D, level, (GLint)internalformat, width, height, depth, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}
	...
	@param Specifies the data type of the pixel data
	@param Specifies the byte offset into PBO data store*/
	void texSubImage3D(PixelUnpackBuffer& buffer, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, TexSubFormat format, TexSubType type, GLintptr offset)
	{
		_texSubImage3D(_tlsTexture3D(), GL_TEXTURE_3D, level, xoffset, yoffset, zoffset, width, height, depth, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}
	...
	void generateMipmap()
	{
		_generateMipmap(_tlsTexture3D(), GL_TEXTURE_3D);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return (TextureCompareMode)_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_COMPARE_MODE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_3D, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_COMPARE_MODE, (GLint)mode);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_SWIZZLE_A);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_SWIZZLE_B);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_SWIZZLE_G);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_SWIZZLE_R);
	}
	...
	{
		_getTexParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_SWIZZLE_RGBA, (GLint*)swizzle);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_SWIZZLE_A, (GLint)swizzle);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_SWIZZLE_B, (GLint)swizzle);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_SWIZZLE_G, (GLint)swizzle);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_SWIZZLE_R, (GLint)swizzle);
	}
	...
	{
		_texParameter(_tlsTexture3D(), GL_TEXTURE_3D, GL_TEXTURE_SWIZZLE_RGBA, (const GLint*)swizzle);
	}
