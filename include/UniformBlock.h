...
public:
	...
	/*(3.1) Returns the index of the uniform buffer binding point last selected by the uniform block object. Used as a getter of <uniformBlockBinding2> property
	...
	/*(3.1) Read-only property for index of the uniform buffer binding point last selected by the uniform block object*/
	__declspec(property(get = getUniformBlockBinding)) GLuint uniformBlockBinding2;
