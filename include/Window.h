...
@return The pointer to current context window object*/
...
private:
	...
	// Window object static data structure
...
public:
	...
	{
		return m.iCursorEntered == GLFW_TRUE;
	}
	...
	{
		return (KeyboardKey)m.iKeyboardKey;
	}
	...
	{
		return (MouseAction)m.iMouseAction;
	}
	...
	{
		return (MouseButton)m.iMouseButton;
	}
	...
	{
		return (bool)(m.iKeyMods & (int)mod);
	}
	...
	{
		return (bool)m.iWindowFullscreen;
	}
	...
	{
		return (bool)m.iWindowIconified;
	}
	...
	{
		return (bool)m.iWindowMaximized;
	}
...
{
	return glfwGetInputMode(m.pWindow, mode);
}

inline int Window::_getWindowAttrib(int attrib)
{
	return glfwGetWindowAttrib(m.pWindow, attrib);
}

inline void Window::_setInputMode(int mode, int value)
{
	glfwSetInputMode(m.pWindow, mode, value);
}

inline void Window::_setWindowAttrib(int attrib, int value)
{
	glfwSetWindowAttrib(m.pWindow, attrib, value);
}
...
{
	return glfwGetClipboardString(m.pWindow);
}

inline void Window::getCursorPos()
{
	glfwGetCursorPos(m.pWindow, &m.dCursorPosX, &m.dCursorPosY);
}

inline void Window::getFramebufferSize()
{
	glfwGetFramebufferSize(m.pWindow, &m.iFramebufferWidth, &m.iFramebufferHeight);
}

inline KeyAction Window::getKey(KeyboardKey key) const
{
	return (KeyAction)glfwGetKey(m.pWindow, (int)key);
}

inline MouseAction Window::getMouseButton(MouseButton button)
{
	return (MouseAction)glfwGetMouseButton(m.pWindow, (int)button);
}

inline void Window::getWindowFrameSize()
{
	glfwGetWindowFrameSize(m.pWindow, &m.iWindowFrameLeft, &m.iWindowFrameTop, &m.iWindowFrameRight, &m.iWindowFrameBottom);
}

inline void Window::getWindowContentScale()
{
	glfwGetWindowContentScale(m.pWindow, &m.fWindowContentScaleX, &m.fWindowContentScaleY);
}

inline float Window::getWindowOpacity()
{
	return glfwGetWindowOpacity(m.pWindow);
}
