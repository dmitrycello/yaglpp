...
public:
	...
	/*(2.1) Gets the size of the buffer object parameter value, measured in bytes. Used as a getter of <bufferSize> property
	...
	@return Buffer expected usage pattern enumerator. The initial value is <StaticDraw>*/
	...
	/*(2.1) Read-only property to determine if the buffer object is currently bound to its target*/
	...
	/*(3.0) Gets the access policy flag parameter value set while mapping the buffer object (the value of the access parameter bitfield passed to <mapBufferRange>). If the buffer was mapped with <mapBuffer>, the access policy is determined by translating the enums in that access parameter to the corresponding bits for <mapBufferRange> as described in the OpenGL Specification. Used as a getter of <getBufferAccessFlags> property
