...
public:
	...
	{
#ifdef _DEBUG
		_object_assign((_Objects&)framebuffers, index, GL_FRAMEBUFFER);
#else // #ifdef _DEBUG
		_object_assign((_Objects&)framebuffers, index);
#endif // #ifdef _DEBUG
	}

	/*(3.0) Explicitly binds framebuffer object to its target, this also affects read and draw framebuffer binding*/
	void bindFramebuffer()
	{
		_framebuffer_rebind(_tlsFramebuffer(), GL_FRAMEBUFFER);
	}
	...
	{
		_blitFramebuffer(*this, _tlsFramebuffer(), GL_FRAMEBUFFER, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
	}
	...
	{
		return (FramebufferCompletenessStatus)_checkFramebufferStatus(_tlsFramebuffer(), GL_FRAMEBUFFER);
	}
	...
	{
		_framebufferRenderbuffer(_tlsFramebuffer(), GL_FRAMEBUFFER, index, renderbuffer);
	}
	...
	{
		_framebufferTexture1D(_tlsFramebuffer(), GL_FRAMEBUFFER, index, GL_TEXTURE_1D, texture, level);
	}
	...
	{
		_framebufferTexture2D(_tlsFramebuffer(), GL_FRAMEBUFFER, index, GL_TEXTURE_2D, texture, level);
	}
	...
	{
		_framebufferTexture2D(_tlsFramebuffer(), GL_FRAMEBUFFER, index, (GLenum)plane, texture, level);
	}
	...
	@param The index of the texture object name, default 0*/
	void framebufferTexture3D(ColorAttachment index, Texture3D& texture, GLint level, GLint layer)
	{
		_framebufferTexture3D(_tlsFramebuffer(), GL_FRAMEBUFFER, index, GL_TEXTURE_3D, texture, level, layer);
	}
	...
	{
		_framebufferTextureLayer(_tlsFramebuffer(), GL_FRAMEBUFFER, index, texture, level, layer);
	}
	...
	{
		return (FramebufferAttachmentType)_getFramebufferAttachmentParameter(_tlsFramebuffer(), GL_FRAMEBUFFER, index, GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE);
	}
	...
	{
		return _getFramebufferAttachmentParameter(_tlsFramebuffer(), GL_FRAMEBUFFER, index, GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL);
	}
	...
	{
		return _getFramebufferAttachmentParameter(_tlsFramebuffer(), GL_FRAMEBUFFER, index, GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER);
	}
	...
	{
		_framebuffer_unbind(_tlsFramebuffer(), GL_FRAMEBUFFER);
	}
	...
	{
		_framebufferTexture2D(_tlsFramebuffer(), GL_FRAMEBUFFER, index, GL_TEXTURE_RECTANGLE, texture, 0);
	}
	...
	{
		_framebufferTexture2D(_tlsFramebuffer(), GL_FRAMEBUFFER, index, GL_TEXTURE_2D_MULTISAMPLE, texture, 0);
	}
	...
	{
		_framebufferTextureLayer(_tlsFramebuffer(), GL_FRAMEBUFFER, index, texture, 0, layer);
	}
	...
	{
		return _getFramebufferAttachmentParameter(_tlsFramebuffer(), GL_FRAMEBUFFER, index, GL_FRAMEBUFFER_ATTACHMENT_LAYERED);
	}
