...
public:
	...
	{
		_framebuffer_rebind(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER);
	}
	...
	{
		_framebuffer_bind(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER);
		_blitFramebuffer((_Framebuffer&)src, _tlsReadFramebuffer(), GL_READ_FRAMEBUFFER, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
	}
	...
	{
		return (FramebufferCompletenessStatus)_checkFramebufferStatus(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER);
	}
	...
	{
		_framebufferRenderbuffer(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, renderbuffer);
	}
	...
	{
		_framebufferTexture1D(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, GL_TEXTURE_1D, texture, level);
	}
	...
	{
		_framebufferTexture2D(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, GL_TEXTURE_2D, texture, level);
	}
	...
	{
		_framebufferTexture2D(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, (GLenum)plane, texture, level);
	}
	...
	{
		_framebufferTexture3D(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, GL_TEXTURE_3D, texture, level, layer);
	}
	...
	{
		_framebufferTextureLayer(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, texture, level, layer);
	}
	...
	{
		return (FramebufferAttachmentType)_getFramebufferAttachmentParameter(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE);
	}
	...
	{
		return _getFramebufferAttachmentParameter(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL);
	}
	...
	{
		return _getFramebufferAttachmentParameter(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER);
	}
	...
	{
		_framebuffer_unbind(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER);
	}

#ifdef YAGLPP_CLASS_PROPERTIES
	/*(3.0) Read-only property to determine if the framebuffer object is currently bound to its target*/
	__declspec(property(get = isFramebufferBinding)) GLboolean framebufferBinding;
	...
	{
		_framebufferTexture2D(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, GL_TEXTURE_RECTANGLE, texture, 0);
	}
	...
	{
		_framebufferTexture2D(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, GL_TEXTURE_2D_MULTISAMPLE, texture, 0);
	}
	...
	{
		_framebufferTextureLayer(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, texture, 0, layer);
	}
	...
	{
		return _getFramebufferAttachmentParameter(_tlsDrawFramebuffer(), GL_DRAW_FRAMEBUFFER, index, GL_FRAMEBUFFER_ATTACHMENT_LAYERED);
	}
