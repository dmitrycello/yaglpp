...
#ifndef YAGLPP_ARRAY_BUFFER_H
#define YAGLPP_ARRAY_BUFFER_H

namespace gl {
/*OpenGL array buffer or vertex buffer object class (VBO) derived from <Buffers>*/
class ArrayBuffer : public Buffers
{
public:
	...
	ArrayBuffer(DataStore& dataStore, Usage usage) : Buffers()
	{
		buffer_create(GL_ARRAY_BUFFER, (GLenum)usage, dataStore);
	}

	/*(3) Constructs array buffer and initializes buffer object's data store with <Data>*/
	ArrayBuffer(GLsizeiptr size, _Pre_maybenull_ const void* data, Usage usage) : Buffers()
	{
		buffer_create(GL_ARRAY_BUFFER, size, data, (GLenum)usage);
	}

	/*Binds buffer object to its target. Does nothing if specified object is bound*/
	void Bind()
	{
		object_bind(glBindBuffer, GL_ARRAY_BUFFER);
	}
	...
	{
		buffer_data(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, (GLenum)usage, dataStore);
	}
	...
	{
		buffer_data(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, size, data, (GLenum)usage);
	}

	/*Generates OpenGL buffer object name in an empty buffer class object, and bind it to its target in one function call*/
	void GenBind()
	{
		object_gen_bind(glGenBuffers, glBindBuffer, GL_ARRAY_BUFFER);
	}
	...
	Access GetAccess()
	{
		return (Access)get_buffer_parameter(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_BUFFER_ACCESS);
	}
	...
	{
		return get_buffer_pointer(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING);
	}
	...
	GLint GetSize()
	{
		return get_buffer_parameter(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_BUFFER_SIZE);
	}
	...
	{
		get_buffer_sub_data(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, offset, size, data);
	}
	...
	Usage GetUsage()
	{
		return (Usage)get_buffer_parameter(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_BUFFER_USAGE);
	}
	...
	{
		return object_binding(GL_ARRAY_BUFFER_BINDING, Get());
	}
	...
	GLboolean IsMapped()
	{
		return get_buffer_parameter(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_BUFFER_MAPPED);
	}
	...
	{
		return map_buffer(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, (GLenum)access);
	}
	...
	{
		buffer_sub_data(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, data);
	}
	...
	{
		buffer_sub_data(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, offset, size, data);
	}
	...
	GLboolean Unmap()
	{
		return unmap_buffer(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING);
	}
	...
	{
		flush_mapped_buffer_range(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, offset, length);
	}
	...
	{
		return (AccessFlags)get_buffer_parameter(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_BUFFER_ACCESS_FLAGS);
	}
	...
	{
		return map_buffer_range(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, offset, length, (GLbitfield)access);
	}
	...
	{
 		copy_buffer_sub_data(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, readOffset, writeOffset, size);
	}
	...
	{
		copy_buffer_sub_data(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_ELEMENT_ARRAY_BUFFER, GL_ELEMENT_ARRAY_BUFFER_BINDING, ((Buffers&)writeBuffer).Get(), readOffset, writeOffset, size);
	}
	...
	{
		copy_buffer_sub_data(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_PIXEL_PACK_BUFFER, GL_PIXEL_PACK_BUFFER_BINDING, ((Buffers&)writeBuffer).Get(), readOffset, writeOffset, size);
	}
	...
	{
		copy_buffer_sub_data(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_PIXEL_UNPACK_BUFFER, GL_PIXEL_UNPACK_BUFFER_BINDING, ((Buffers&)writeBuffer).Get(), readOffset, writeOffset, size);
	}
	...
	{
		copy_buffer_sub_data(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_TRANSFORM_FEEDBACK_BUFFER, GL_TRANSFORM_FEEDBACK_BUFFER_BINDING, ((Buffers&)writeBuffer).Get(), readOffset, writeOffset, size);
	}
	...
	{
		copy_buffer_sub_data(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_TEXTURE_BUFFER, GL_TEXTURE_BUFFER_BINDING, ((Buffers&)writeBuffer).Get(), readOffset, writeOffset, size);
	}
	...
	{
		copy_buffer_sub_data(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_UNIFORM_BUFFER, GL_UNIFORM_BUFFER_BINDING, ((Buffers&)writeBuffer).Get(), readOffset, writeOffset, size);
	}
	...
	{
		return get_buffer_parameter64(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_BUFFER_MAP_LENGTH);
	}
	...
	{
		return get_buffer_parameter64(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_BUFFER_MAP_OFFSET);
	}
	...
	GLint64 GetSize64()
	{
		return get_buffer_parameter64(GL_ARRAY_BUFFER, GL_ARRAY_BUFFER_BINDING, GL_BUFFER_SIZE);
	}
...
#endif // #ifndef YAGLPP_ARRAY_BUFFER_H
