...
protected:
	...
	friend void ReadPixels(GLint, GLint, GLsizei, GLsizei, ReadFormat, ReadType, _Out_ void*);
	friend void ReadPixels(PixelPackBuffer&, GLint, GLint, GLsizei, GLsizei, ReadFormat, ReadType, GLintptr);
