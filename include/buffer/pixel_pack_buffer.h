...
public:
	...
	PixelPackBuffer(const PixelPackBuffer& source)
	{
	...
	void duplicateBuffer(const PixelPackBuffer& source)
	{
		_buffer_dup((_Object&)source);
	}
	...
	GLboolean isDuplicate(const PixelPackBuffer& source) const
	{
	...
	@param Specifies the source buffer object*/
	void referBuffer(const PixelPackBuffer& source)
	{
