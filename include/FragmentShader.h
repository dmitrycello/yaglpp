...
public:
	...
	/*Gets a symbolic constant indicating the mode of the derivative accuracy hint for fragment shaders. Used as the getter of <fragmentShaderDerivativeHint> property
	...
	/*Set the accuracy of the derivative calculation for the GL shading language fragment processing built-in functions: dFdx, dFdy, and fwidth. Used as the setter of <fragmentShaderDerivativeHint> property
	...
	/*Read-write property for derivative accuracy hint of fragment shaders*/
	__declspec(property(get = getFragmentShaderDerivativeHint, put = setFragmentShaderDerivativeHint)) BehaviorHint fragmentShaderDerivativeHint;
