...
public:
	...
	Texture1D& getTexture1D(GLuint index)
	{
	...
	@param Specifies the object name index*/
	Texture2D& getTexture2D(GLuint index)
	{
	...
	@param Specifies the object name index*/
	Texture3D& getTexture3D(GLuint index)
	{
	...
	@param Specifies the object name index*/
	TextureCubeMap& getTextureCubeMap(GLuint index)
	{
	...
	@param Specifies the object name index*/
	Texture1DArray& getTexture1DArray(GLuint index)
	{
	...
	@param Specifies the object name index*/
	Texture2DArray& getTexture2DArray(GLuint index)
	{
	...
	@param Specifies the object name index*/
	BufferTexture& getBufferTexture(GLuint index)
	{
	...
	@param Specifies the object name index*/
	TextureRectangle& getTextureRectangle(GLuint index)
	{
	...
	@param Specifies the object name index*/
	Texture2DMultisample& getTexture2DMultisample(GLuint index)
	{
	...
	@param Specifies the object name index*/
	Texture2DMultisampleArray& getTexture2DMultisampleArray(GLuint index)
	{
