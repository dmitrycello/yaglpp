...
#ifndef YAGLPP_TEXTURE_2D_H
#define YAGLPP_TEXTURE_2D_H

namespace gl {
/*OpenGL two-dimensional texture object class derived from <Textures>*/
class Texture2D : public Textures
{
public:
	...
	void Bind()
	{
		object_bind(glBindTexture, GL_TEXTURE_2D);
	}
	...
	void GenBind()
	{
		object_gen_bind(glGenTextures, glBindTexture, GL_TEXTURE_2D);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_ALPHA_SIZE);
	}

	/*Returns the current base texture mipmap level. The initial value is 0. MSVC getter for <baseLevel> property
	@return The lowest defined mipmap level*/
	GLint GetBaseLevel()
	{
		return get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_BASE_LEVEL);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		return (CompareFunc)get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_COMPARE_FUNC);
	}

	/*(1) Return a compressed two-dimensional texture image into client's memory of the size returned by <GetCompressedImageSize>. (2.1) Pixel pack buffer must be unbound from its target
	@param Specifies the level-of-detail number of the desired image
	@param [out] Specifies a pointer to store the compressed texture image*/
	void GetCompressedImage(GLint level, _Out_ void* pixels)
	{
		get_compressed_tex_image(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, pixels);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	/*(1) Returns a two-dimensional texture image into client's memory. (2.1) Pixel pack buffer must be unbound from its target
	@param Specifies the level-of-detail number of the desired image
	...
	{
		get_tex_image(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, (GLenum)format, (GLenum)type, pixels);
	}
	...
	{
		return (Internalformat)get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	GLfloat GetLodBias()
	{
		return get_tex_parameter_float(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_LOD_BIAS);
	}

	/*Gets the current texture magnification function. The initial value is <Linear>. MSVC getter for <magFilter> property
	@return The texture magnification function value*/
	MagFilter GetMagFilter()
	{
		return (MagFilter)get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_MAG_FILTER);
	}
	...
	GLint GetMaxLevel()
	{
		return get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_MAX_LEVEL);
	}
	...
	GLfloat GetMaxLod()
	{
		return get_tex_parameter_float(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_MAX_LOD);
	}
	...
	{
		return (MinFilter)get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_MIN_FILTER);
	}
	...
	GLfloat GetMinLod()
	{
		return get_tex_parameter_float(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_MIN_LOD);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return (Internalformat)get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_RED_SIZE);
	}

	/*Returns the width capacity of the proxy texture. The initial value is 0
	@param Specifies the level-of-detail number of the desired image
	@return The width capacity of the texture*/
	static GLsizei GetProxyWidth(GLint level)
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_WIDTH);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_WIDTH);
	}
	...
	WrapMode GetWrapR()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_WRAP_R);
	}
	...
	WrapMode GetWrapS()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_WRAP_S);
	}
	...
	WrapMode GetWrapT()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_WRAP_T);
	}
	...
	{
		return object_binding(GL_TEXTURE_BINDING_2D, Get());
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_BASE_LEVEL, level);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_COMPARE_FUNC, (GLint)func);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_LOD_BIAS, bias);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_MAG_FILTER, (GLint)filter);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_MAX_LEVEL, maxlevel);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_MAX_LOD, maxlod);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_MIN_FILTER, (GLint)filter);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_MIN_LOD, minlod);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_WRAP_R, (GLint)wrap);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_WRAP_S, (GLint)wrap);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_WRAP_T, (GLint)wrap);
	}
	...
	{
		get_compressed_tex_image(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, buffer.Get(), offset);
	}
	...
	{
		get_tex_image(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, (GLenum)format, (GLenum)type, buffer.Get(), offset);
	}
	...
	void GenerateMipmap()
	{
		generate_mipmap(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return (CompareMode)get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_COMPARE_MODE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_2D, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_COMPARE_MODE, (GLint)mode);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_SWIZZLE_A);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_SWIZZLE_B);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_SWIZZLE_G);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_SWIZZLE_R);
	}
	...
	{
		get_tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_SWIZZLE_RGBA, (GLint*)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_SWIZZLE_A, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_SWIZZLE_B, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_SWIZZLE_G, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_SWIZZLE_R, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D, GL_TEXTURE_BINDING_2D, GL_TEXTURE_SWIZZLE_RGBA, (const GLint*)swizzle);
	}
...
#endif // #ifndef YAGLPP_TEXTURE_2D_H
