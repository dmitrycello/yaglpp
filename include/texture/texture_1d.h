...
#ifndef YAGLPP_TEXTURE_1D_H
#define YAGLPP_TEXTURE_1D_H

namespace gl {
/*OpenGL one-dimensional texture object class derived from <Textures>*/
class Texture1D : public Textures
{
public:
	...
	void Bind()
	{
		object_bind(glBindTexture, GL_TEXTURE_1D);
	}
	...
	void GenBind()
	{
		object_gen_bind(glGenTextures, glBindTexture, GL_TEXTURE_1D);
	}
	...
	{
		get_compressed_tex_image(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, pixels);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return (Internalformat)get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_WIDTH);
	}
	...
	{
		get_tex_image(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, (GLenum)format, (GLenum)type, pixels);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	GLint GetBaseLevel()
	{
		return get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_BASE_LEVEL);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		return (CompareFunc)get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_COMPARE_FUNC);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return (Internalformat)get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	GLfloat GetLodBias()
	{
		return get_tex_parameter_float(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_LOD_BIAS);
	}
	...
	{
		return (MagFilter)get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_MAG_FILTER);
	}
	...
	GLint GetMaxLevel()
	{
		return get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_MAX_LEVEL);
	}
	...
	GLfloat GetMaxLod()
	{
		return get_tex_parameter_float(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_MAX_LOD);
	}
	...
	{
		return (MinFilter)get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_MIN_FILTER);
	}
	...
	GLfloat GetMinLod()
	{
		return get_tex_parameter_float(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_MIN_LOD);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_WIDTH);
	}
	...
	WrapMode GetWrapR()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_WRAP_R);
	}
	...
	WrapMode GetWrapS()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_WRAP_S);
	}
	...
	WrapMode GetWrapT()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_WRAP_T);
	}
	...
	{
		return object_binding(GL_TEXTURE_BINDING_1D, Get());
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_BASE_LEVEL, level);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_COMPARE_FUNC, (GLint)func);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_LOD_BIAS, bias);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_MAG_FILTER, (GLint)filter);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_MAX_LEVEL, maxlevel);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_MAX_LOD, maxlod);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_MIN_FILTER, (GLint)filter);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_MIN_LOD, minlod);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_WRAP_R, (GLint)wrap);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_WRAP_S, (GLint)wrap);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_WRAP_T, (GLint)wrap);
	}
	...
	@param Specifies the data type of the pixel data
	@param [in] Specifies a pointer to the image data in memory*/
	void SubImage(GLint level, GLint xoffset, GLsizei width, Format format, Type type, _In_ const void* pixels)
	{
	...
	{
		get_compressed_tex_image(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, buffer.Get(), offset);
	}
	...
	{
		get_tex_image(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, (GLenum)format, (GLenum)type, buffer.Get(), offset);
	}
	...
	void GenerateMipmap()
	{
		generate_mipmap(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_1D, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return (CompareMode)get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_COMPARE_MODE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_COMPARE_MODE, (GLint)mode);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_SWIZZLE_A);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_SWIZZLE_B);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_SWIZZLE_G);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_SWIZZLE_R);
	}
	...
	{
		get_tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_SWIZZLE_RGBA, (GLint*)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_SWIZZLE_A, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_SWIZZLE_B, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_SWIZZLE_G, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_SWIZZLE_R, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, GL_TEXTURE_SWIZZLE_RGBA, (const GLint*)swizzle);
	}
...
#endif // #ifndef YAGLPP_TEXTURE_1D_H
