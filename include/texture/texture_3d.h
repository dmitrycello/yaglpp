...
#ifndef YAGLPP_TEXTURE_3D_H
#define YAGLPP_TEXTURE_3D_H

namespace gl {
/*OpenGL three-dimensional texture object class derived from <Textures>*/
class Texture3D : public Textures
{
public:
	...
	void Bind()
	{
		object_bind(glBindTexture, GL_TEXTURE_3D);
	}
	...
	void GenBind()
	{
		object_gen_bind(glGenTextures, glBindTexture, GL_TEXTURE_3D);
	}

	/*(1) Return a compressed three-dimensional texture image into client's memory of the size returned by <GetCompressedImageSize>. (2.1) Pixel pack buffer must be unbound from its target
	...
	{
		get_compressed_tex_image(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, pixels);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	GLint GetBaseLevel()
	{
		return get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_BASE_LEVEL);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		return (CompareFunc)get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_COMPARE_FUNC);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	/*(1) Returns a three-dimensional texture image into client's memory. (2.1) Pixel pack buffer must be unbound from its target
	@param Specifies the level-of-detail number of the desired image
	...
	{
		get_tex_image(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, (GLenum)format, (GLenum)type, pixels);
	}
	...
	{
		return (Internalformat)get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	GLfloat GetLodBias()
	{
		return get_tex_parameter_float(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_LOD_BIAS);
	}
	...
	{
		return (MagFilter)get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_MAG_FILTER);
	}
	...
	GLint GetMaxLevel()
	{
		return get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_MAX_LEVEL);
	}
	...
	GLfloat GetMaxLod()
	{
		return get_tex_parameter_float(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_MAX_LOD);
	}
	...
	{
		return (MinFilter)get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_MIN_FILTER);
	}
	...
	GLfloat GetMinLod()
	{
		return get_tex_parameter_float(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_MIN_LOD);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return (Internalformat)get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_INTERNAL_FORMAT);
	}

	/*Returns the number of layers in the proxy texture
	@param Specifies the level-of-detail number of the proxy texture
	@return The number of layers in the texture image*/
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_WIDTH);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_WIDTH);
	}
	...
	WrapMode GetWrapR()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_WRAP_R);
	}
	...
	WrapMode GetWrapS()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_WRAP_S);
	}
	...
	WrapMode GetWrapT()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_WRAP_T);
	}
	...
	{
		return object_binding(GL_TEXTURE_BINDING_3D, Get());
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_BASE_LEVEL, level);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_COMPARE_FUNC, (GLint)func);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_LOD_BIAS, bias);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_MAG_FILTER, (GLint)filter);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_MAX_LEVEL, maxlevel);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_MAX_LOD, maxlod);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_MIN_FILTER, (GLint)filter);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_MIN_LOD, minlod);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_WRAP_R, (GLint)wrap);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_WRAP_S, (GLint)wrap);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_WRAP_T, (GLint)wrap);
	}
	...
	{
		get_compressed_tex_image(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, buffer.Get(), offset);
	}
	...
	{
		get_tex_image(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, (GLenum)format, (GLenum)type, buffer.Get(), offset);
	}
	...
	void GenerateMipmap()
	{
		generate_mipmap(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return (CompareMode)get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_COMPARE_MODE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_3D, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_COMPARE_MODE, (GLint)mode);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_SWIZZLE_A);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_SWIZZLE_B);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_SWIZZLE_G);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_SWIZZLE_R);
	}
	...
	{
		get_tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_SWIZZLE_RGBA, (GLint*)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_SWIZZLE_A, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_SWIZZLE_B, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_SWIZZLE_G, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_SWIZZLE_R, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_3D, GL_TEXTURE_BINDING_3D, GL_TEXTURE_SWIZZLE_RGBA, (const GLint*)swizzle);
	}
...
#endif // #ifndef YAGLPP_TEXTURE_3D_H
