...
public:
	...
	{
		_activeTexture(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, index);
	}

	/*(3.0) Explicitly binds texture object to its target. Does nothing if specified texture is bound*/
	void bindTexture()
	{
		_bindTexture(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY);
	}
	...
	void compressedTexImage(GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei layers, GLsizei imageSize, _In_ const void* data)
	{
		_compressedTexImage2D(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, (GLenum)internalformat, width, layers, imageSize, data);
	}
	...
	void compressedTexImage(PixelUnpackBuffer& buffer, GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei layers, GLsizei imageSize, GLintptr offset)
	{
		_compressedTexImage2D(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, (GLenum)internalformat, width, layers, imageSize, (_Buffer&)buffer, offset);
	}
	...
	static void compressedTexImageProxy(GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei layers, GLsizei imageSize)
	{
	...
	@param Specifies the number of unsigned bytes of image data starting at the specified data address
	@param [in] Specifies a pointer to the compressed image data in memory*/
	void compressedTexSubImage(GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei layers, CompressedTexInternalformat internalformat, GLsizei imageSize, _In_ const void* data)
	{
		_compressedTexSubImage2D(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, xoffset, yoffset, width, layers, (GLenum)internalformat, imageSize, data);
	}
	...
	@param Specifies the number of unsigned bytes of image data starting at the specified data offset into PBO data store
	@param Specifies the byte offset into PBO data store*/
	void compressedTexSubImage(PixelUnpackBuffer& buffer, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei layers, CompressedTexInternalformat internalformat, GLsizei imageSize, GLintptr offset)
	{
		_compressedTexSubImage2D(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, xoffset, yoffset, width, layers, (GLenum)internalformat, imageSize, (_Buffer&)buffer, offset);
	}
	...
	void generateMipmap()
	{
		_generateMipmap(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY);
	}
	...
	{
		_getCompressedTexImage(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, pixels);
	}
	...
	{
		_getCompressedTexImage(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, (_Buffer&)buffer, offset);
	}
	...
	{
		_getTexImage(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, (GLenum)format, (GLenum)type, pixels);
	}
	...
	{
		_getTexImage(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return _getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_BASE_LEVEL);
	}

	/*(3.0) Returns a reference texture object currently bound to its target
	@return The reference texture object, or empty object*/
	static Texture1DArray getTextureBinding()
	{
		return Texture1DArray(_getInteger(GL_TEXTURE_BINDING_1D_ARRAY));
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		_getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		return (CompareFunc)_getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_COMPARE_FUNC);
	}
	...
	{
		return (TextureCompareMode)_getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_COMPARE_MODE);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_HEIGHT);
	}
	...
	{
		return (TexInternalformat)_getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_DEPTH);
	}
	...
	{
		return _getTexParameterFloat(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_LOD_BIAS);
	}
	...
	{
		return (TextureMagFilter)_getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MAG_FILTER);
	}
	...
	{
		return _getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MAX_LEVEL);
	}
	...
	{
		return _getTexParameterFloat(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MAX_LOD);
	}
	...
	{
		return (TextureMinFilter)_getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MIN_FILTER);
	}
	...
	{
		return _getTexParameterFloat(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MIN_LOD);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_WIDTH);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_WRAP_R);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_WRAP_S);
	}
	...
	{
		return _object_id() == (GLuint)_getInteger(GL_TEXTURE_BINDING_1D_ARRAY);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_BASE_LEVEL, level);
	}
	...
	{
		_texture_set(GL_TEXTURE_1D, GL_TEXTURE_BINDING_1D, bind);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_COMPARE_FUNC, (GLint)func);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_COMPARE_MODE, (GLint)mode);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_LOD_BIAS, bias);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MAG_FILTER, (GLint)filter);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MAX_LEVEL, maxlevel);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MAX_LOD, maxlod);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MIN_FILTER, (GLint)filter);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MIN_LOD, minlod);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_WRAP_R, (GLint)wrap);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_WRAP_S, (GLint)wrap);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_WRAP_T, (GLint)wrap);
	}
	...
	{
		_texImage2D(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, _stbGetFormat(image), image);
	}

	/*(3.0) (2) Specifies a one-dimensional multi-layered texture image initialized from the StbImage object with specified texture internal format. (2.1) Unbinds pixel unpack buffer from its target
	@param Specifies the StbImage object with loaded image
	@param Specifies the level-of-detail number
	@param Specifies the texture internal formats*/
	void texImage(StbImage& image, GLint level, TexInternalformat internalformat)
	{
		_texImage2D(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, (GLint)internalformat, image);
	}

	/*(3.0) (3) Specifies a one-dimensional multi-layered texture image initialized from client's memory. (2.1) Unbinds pixel unpack buffer from its target
	@param Specifies the level-of-detail number
	@param Specifies the texture internal formats
	...
	void texImage(GLint level, TexInternalformat internalformat, GLsizei width, GLsizei layers, TexFormat format, TexType type, _In_ const void* data)
	{
		_texImage2D(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, (GLint)internalformat, width, layers, (GLenum)format, (GLenum)type, data);
	}
	...
	@param Specifies the data type of the pixel data
	@param Specifies the byte offset into PBO data store*/
	void texImage(PixelUnpackBuffer& buffer, GLint level, TexInternalformat internalformat, GLsizei width, GLsizei layers, TexFormat format, TexType type, GLintptr offset)
	{
		_texImage2D(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, (GLint)internalformat, width, layers, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}
	...
	@param Specifies the format of the pixel data
	@param Specifies the data type of the pixel data*/
	static void texImageProxy(GLint level, TexInternalformat internalformat, GLsizei width, GLsizei layers, TexFormat format, TexType type)
	{
	...
	{
		_texSubImage2D(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, xoffset, yoffset, image);
	}
	...
	@param Specifies the data type of the pixel data
	@param [in] Specifies a pointer to the image data in memory*/
	void texSubImage(GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei layers, TexSubFormat format, TexSubType type, _In_ const void* pixels)
	{
		_texSubImage2D(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, xoffset, yoffset, width, layers, (GLenum)format, (GLenum)type, pixels);
	}
	...
	@param Specifies the data type of the pixel data
	@param Specifies the byte offset into PBO data store*/
	void texSubImage(PixelUnpackBuffer& buffer, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei layers, TexSubFormat format, TexSubType type, GLintptr offset)
	{
		_texSubImage2D(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, xoffset, yoffset, width, layers, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_A);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_B);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_G);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_R);
	}
	...
	{
		_getTexParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_RGBA, (GLint*)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_A, (GLint)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_B, (GLint)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_G, (GLint)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_R, (GLint)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_RGBA, (const GLint*)swizzle);
	}
...
/*(3.0) Returns a reference Texture1DArray object currently bound to its target
@return The reference Texture1DArray object, or empty object*/
inline Texture1DArray getTexture1DArrayBinding()
{
	return Texture1DArray::getTextureBinding();
}

/*(3.0) Explicitly unbinds any texture object of specified type bound to its target. Does nothing if no such texture is bound*/
inline void unbindTexture1DArray()
{
	Texture1DArray::unbindTarget();
}
} // namespace gl
