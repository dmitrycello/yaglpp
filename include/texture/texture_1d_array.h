...
public:
	...
	void Bind()
	{
		object_bind(glBindTexture, GL_TEXTURE_1D_ARRAY);
	}
	...
	void GenBind()
	{
		object_gen_bind(glGenTextures, glBindTexture, GL_TEXTURE_1D_ARRAY);
	}

	/*(3.0) Generates mipmaps for specified texture target*/
	void GenerateMipmap()
	{
		generate_mipmap(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY);
	}

	/*(3.0) (1) Return a compressed one-dimensional multi-layered texture image into client's memory of the size returned by <GetCompressedImageSize>. Pixel pack buffer must be unbound from its target
	...
	{
		get_compressed_tex_image(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, pixels);
	}
	...
	{
		get_compressed_tex_image(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, buffer.Get(), offset);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_ALPHA_TYPE);
	}

	/*(3.0) Returns the current base texture mipmap level. The initial value is 0. Used as the getter of <baseLevel> property
	@return The lowest defined mipmap level*/
	GLint GetBaseLevel()
	{
		return get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_BASE_LEVEL);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	/*(3.0) Returns the current texture comparison function. The initial value is <Lequal>. Used as the getter of <compareFunc> property
	@return The texture comparison function value*/
	CompareFunc GetCompareFunc()
	{
		return (CompareFunc)get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_COMPARE_FUNC);
	}

	/*(3.0) Gets the texture comparison mode for currently bound depth textures. Used as the getter of <compareMode> property
	@return Returns one of the selected texture compare mode values*/
	CompareMode GetCompareMode()
	{
		return (CompareMode)get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_COMPARE_MODE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_GREEN_TYPE);
	}

	/*(3.0) (1) Returns a one-dimensional multi-layered texture image into client's memory. Pixel pack buffer must be unbound from its target
	@param Specifies the level-of-detail number of the desired image
	...
	{
		get_tex_image(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, (GLenum)format, (GLenum)type, pixels);
	}
	...
	{
		get_tex_image(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, (GLenum)format, (GLenum)type, buffer.Get(), offset);
	}
	...
	{
		return (Internalformat)get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	/*(3.0) Returns the current fixed level-of-detail bias value. Used as the getter of <lodBias> property
	@return The texture level-of-detail bias value*/
	GLfloat GetLodBias()
	{
		return get_tex_parameter_float(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_LOD_BIAS);
	}

	/*(3.0) Gets the current texture magnification function. The initial value is <Linear>. Used as the getter of <magFilter> property
	@return The texture magnification function value*/
	MagFilter GetMagFilter()
	{
		return (MagFilter)get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MAG_FILTER);
	}

	/*(3.0) Returns the current maximum texture mipmap array level. The initial value is 1000. Used as the getter of <maxLevel> property
	@return The texture maximum mipmap level*/
	GLint GetMaxLevel()
	{
		return get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MAX_LEVEL);
	}

	/*(3.0) Returns the current texture maximum level-of-detail value. The initial value is 1000. Used as the getter of <maxLod> property
	@return The maximum level-of-detail value*/
	GLfloat GetMaxLod()
	{
		return get_tex_parameter_float(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MAX_LOD);
	}

	/*(3.0) Gets the current texture minifying function. The initial value is <NearestMipmapLinear>. Used as the getter of <minFilter> property
	@return The texture minifying function value*/
	MinFilter GetMinFilter()
	{
		return (MinFilter)get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MIN_FILTER);
	}

	/*(3.0) Returns the current texture minimum level-of-detail value. The initial value is -1000. Used as the getter of <minLod> property
	@return The minimum level-of-detail value*/
	GLfloat GetMinLod()
	{
		return get_tex_parameter_float(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MIN_LOD);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return (Internalformat)get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_WIDTH);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_WIDTH);
	}

	/*(3.0) Returns the wrapping function for texture coordinate r. The initial value is <Repeat>. Used as the getter of <wrapR> property
	@return The current wrap mode for texture coordinate r*/
	WrapMode GetWrapR()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_WRAP_R);
	}

	/*(3.0) Returns the wrapping function for texture coordinate s. The initial value is <Repeat>. Used as the getter of <wrapS> property
	@return The current wrap mode for texture coordinate s*/
	WrapMode GetWrapS()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_WRAP_S);
	}

	/*(3.0) Returns the wrapping function for texture coordinate t. The initial value is <Repeat>. Used as the getter of <wrapT> property
	@return The current wrap mode for texture coordinate t*/
	WrapMode GetWrapT()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_WRAP_T);
	}
	...
	{
		return object_binding(GL_TEXTURE_BINDING_1D_ARRAY, Get());
	}
	...
	{
		return get_tex_level_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_1D_ARRAY, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_BASE_LEVEL, level);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_COMPARE_FUNC, (GLint)func);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_COMPARE_MODE, (GLint)mode);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_LOD_BIAS, bias);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MAG_FILTER, (GLint)filter);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MAX_LEVEL, maxlevel);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MAX_LOD, maxlod);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MIN_FILTER, (GLint)filter);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_MIN_LOD, minlod);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_WRAP_R, (GLint)wrap);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_WRAP_S, (GLint)wrap);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_WRAP_T, (GLint)wrap);
	}
	...
	/*(3.3) Returns the current alpha component swizzle value. The initial value is <Alpha>. Used as the getter of <swizzleA> property
	@return The alpha component swizzle value*/
	SwizzleMask GetSwizzleA()
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_A);
	}

	/*(3.3) Returns the current blue component swizzle value. The initial value is <Blue>. Used as the getter of <swizzleB> property
	@return The blue component swizzle value>*/
	SwizzleMask GetSwizzleB()
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_B);
	}

	/*(3.3) Returns the current green component swizzle value. The initial value is <Green>. Used as the getter of <swizzleG> property
	@return The green component swizzle value*/
	SwizzleMask GetSwizzleG()
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_G);
	}

	/*(3.3) Returns the current red component swizzle value. The initial value is <Red>. Used as the getter of <swizzleR> property
	@return The red component swizzle value*/
	SwizzleMask GetSwizzleR()
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_R);
	}
	...
	{
		get_tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_RGBA, (GLint*)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_A, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_B, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_G, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_R, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_1D_ARRAY, GL_TEXTURE_BINDING_1D_ARRAY, GL_TEXTURE_SWIZZLE_RGBA, (const GLint*)swizzle);
	}
...
#endif // #ifndef YAGLPP_TEXTURE_1D_ARRAY_H
