...
#ifndef YAGLPP_TEXTURE_CUBE_MAP_H
#define YAGLPP_TEXTURE_CUBE_MAP_H

namespace gl {
/*OpenGL two-dimensional six-face cube map texture object class derived from <Textures>*/
class TextureCubeMap : public Textures
{
public:
	...
	void Bind()
	{
		object_bind(glBindTexture, GL_TEXTURE_CUBE_MAP);
	}
	...
	void GenBind()
	{
		object_gen_bind(glGenTextures, glBindTexture, GL_TEXTURE_CUBE_MAP);
	}
	...
	/*Returns the current base texture mipmap level. The initial value is 0. Used as the getter of <baseLevel> property
	@return The lowest defined mipmap level*/
	GLint GetBaseLevel()
	{
		return get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_BASE_LEVEL);
	}
	...
	{
		get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	/*Returns the current texture comparison function. The initial value is <Lequal>. Used as the getter of <compareFunc> property
	@return The texture comparison function value*/
	CompareFunc GetCompareFunc()
	{
		return (CompareFunc)get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_COMPARE_FUNC);
	}
	...
	/*Returns the current fixed level-of-detail bias value. Used as the getter of <lodBias> property
	@return The texture level-of-detail bias value*/
	GLfloat GetLodBias()
	{
		return get_tex_parameter_float(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_LOD_BIAS);
	}

	/*Gets the current texture magnification function. The initial value is <Linear>. Used as the getter of <magFilter> property
	@return The texture magnification function value*/
	MagFilter GetMagFilter()
	{
		return (MagFilter)get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MAG_FILTER);
	}

	/*Returns the current maximum texture mipmap array level. The initial value is 1000. Used as the getter of <maxLevel> property
	@return The texture maximum mipmap level*/
	GLint GetMaxLevel()
	{
		return get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MAX_LEVEL);
	}

	/*Returns the current texture maximum level-of-detail value. The initial value is 1000. Used as the getter of <maxLod> property
	@return The maximum level-of-detail value*/
	GLfloat GetMaxLod()
	{
		return get_tex_parameter_float(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MAX_LOD);
	}

	/*Gets the current texture minifying function. The initial value is <NearestMipmapLinear>. Used as the getter of <minFilter> property
	@return The texture minifying function value*/
	MinFilter GetMinFilter()
	{
		return (MinFilter)get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MIN_FILTER);
	}

	/*Returns the current texture minimum level-of-detail value. The initial value is -1000. Used as the getter of <minLod> property
	@return The minimum level-of-detail value*/
	GLfloat GetMinLod()
	{
		return get_tex_parameter_float(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MIN_LOD);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return (Internalformat)get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_WIDTH);
	}
	...
	/*Returns the wrapping function for texture coordinate r. The initial value is <Repeat>. Used as the getter of <wrapR> property
	@return The current wrap mode for texture coordinate r*/
	WrapMode GetWrapR()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_WRAP_R);
	}

	/*Returns the wrapping function for texture coordinate s. The initial value is <Repeat>. Used as the getter of <wrapS> property
	@return The current wrap mode for texture coordinate s*/
	WrapMode GetWrapS()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_WRAP_S);
	}

	/*Returns the wrapping function for texture coordinate t. The initial value is <Repeat>. Used as the getter of <wrapT> property
	@return The current wrap mode for texture coordinate t*/
	WrapMode GetWrapT()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_WRAP_T);
	}
	...
	{
		return object_binding(GL_TEXTURE_BINDING_CUBE_MAP, Get());
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_COMPRESSED);
	}
	...
	/*Specifies the index of the lowest defined mipmap level. The initial value is 0. MSVC setter for <baseLevel> property
	@param The lowest defined mipmap level*/
	void SetBaseLevel(GLint level)
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_BASE_LEVEL, level);
	}
	...
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_COMPARE_FUNC, (GLint)func);
	}

	/*Specifies a fixed bias value that is to be added to the level-of-detail parameter for the texture before texture sampling. MSVC setter for <lodBias> property
	...
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_LOD_BIAS, bias);
	}

	/*Sets the texture magnification function value. The initial value is <Linear>. MSVC setter for <magFilter> property
	@param Specifies the texture magnification function's value*/
	void SetMagFilter(MagFilter filter)
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MAG_FILTER, (GLint)filter);
	}

	/*Sets the index of the highest defined mipmap level. The initial value is 1000. MSVC setter for <maxLevel> property
	@param The texture maximum mipmap level*/
	void SetMaxLevel(GLint maxlevel)
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MAX_LEVEL, maxlevel);
	}

	/*Sets the maximum level-of-detail value that limits the selection of the lowest resolution mipmap. The initial value is 1000. MSVC setter for <maxLod> property
	@param The maximum level-of-detail value*/
	void SetMaxLod(GLfloat maxlod)
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MAX_LOD, maxlod);
	}

	/*The texture minifying function is used whenever the level-of-detail function used when sampling from the texture determines that the texture should be minified. The initial value is <NearestMipmapLinear>. MSVC setter for <minFilter> property
	@param The texture minifying function value*/
	void SetMinFilter(MinFilter filter)
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MIN_FILTER, (GLint)filter);
	}

	/*Sets the minimum level-of-detail value that limits the selection of the highest resolution mipmap. The initial value is -1000. MSVC setter for <minLod> property
	@param The minimum level-of-detail value*/
	void SetMinLod(GLfloat minlod)
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MIN_LOD, minlod);
	}

	/*Sets the wrapping function for texture coordinate r. MSVC setter for <wrapR> property
	@param The texture wrap mode for coordinate r*/
	void SetWrapR(WrapMode wrap)
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_WRAP_R, (GLint)wrap);
	}

	/*Sets the wrapping function for texture coordinate s. MSVC setter for <wrapS> property
	@param The texture wrap mode for coordinate s*/
	void SetWrapS(WrapMode wrap)
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_WRAP_S, (GLint)wrap);
	}

	/*Sets the wrapping function for texture coordinate t. MSVC setter for <wrapT> property
	@param The texture wrap mode for coordinate t*/
	void SetWrapT(WrapMode wrap)
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_WRAP_T, (GLint)wrap);
	}
	...
	void GenerateMipmap()
	{
		generate_mipmap(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP);
	}
	...
	{
		return (CompareMode)get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_COMPARE_MODE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_COMPARE_MODE, (GLint)mode);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_A);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_B);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_G);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_R);
	}
	...
	{
		get_tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_RGBA, (GLint*)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_A, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_B, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_G, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_R, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_RGBA, (const GLint*)swizzle);
	}
...
#endif // #ifndef YAGLPP_TEXTURE_CUBE_MAP_H
