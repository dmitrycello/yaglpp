...
/*OpenGL two-dimensional six-face cube map texture object class derived from <_Texture>*/
...
public:
	...
	{
		_activeTexture(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, index);
	}

	/*Explicitly binds texture object to its target. Does nothing if specified texture is bound*/
	void bindTexture()
	{
		_bindTexture(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP);
	}

	/*(1) Specifies a two-dimensional cube map plane's texture image in a compressed format. (2.1) Unbinds pixel unpack buffer from its target
	...
	void compressedTexImage(TextureCubeMapPlane plane, GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei imageSize, _In_ const void* data)
	{
		_compressedTexImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, (GLenum)internalformat, width, height, imageSize, data);
	}
	...
	{
		_compressedTexImage2D(GL_PROXY_TEXTURE_CUBE_MAP, level, (GLenum)internalformat, width, height, imageSize, nullptr);
	}

	/*(1) Replaces a contiguous subregion of an existing two-dimensional cube map plane's texture image in a compressed format. (2.1) Unbinds pixel unpack buffer from its target
	@param Specifies the cube map plane to process
	@param Specifies the level-of-detail number
	...
	@param Specifies the number of unsigned bytes of image data starting at the specified data address
	@param [in] Specifies a pointer to the compressed image data in memory*/
	void compressedTexSubImage(TextureCubeMapPlane plane, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, CompressedTexInternalformat internalformat, GLsizei imageSize, _In_ const void* data)
	{
		_compressedTexSubImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, xoffset, yoffset, width, height, (GLenum)internalformat, imageSize, data);
	}
	...
	@param Specifies the width of the texture image
	@param Specifies the height of the texture image*/
	void copyTexImage(TextureCubeMapPlane plane, GLint level, CopyTexInternalformat internalformat, GLint x, GLint y, GLsizei width, GLsizei height)
	{
		_copyTexImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, (GLenum)internalformat, x, y, width, height);
	}
	...
	@param Specifies the width of the texture subimage
	@param Specifies the height of the texture subimage*/
	void copyTexSubImage(TextureCubeMapPlane plane, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height)
	{
		_copyTexSubImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, xoffset, yoffset, x, y, width, height);
	}

	/*Disable enabled cube map texturing server-side GL capability, initially enabled*/
	static void disableTextureCubeMap()
	{
	...
	static void enableTextureCubeMap()
	{
		_enable(GL_TEXTURE_CUBE_MAP);
	}

	/*(1) Return a compressed two-dimensional cube map plane's texture image into client's memory of the size returned by <getTextureCompressedImageSize>. (2.1) Unbinds pixel pack buffer from its target
	@param Specifies the cube map plane to process
	...
	void getCompressedTexImage(TextureCubeMapPlane plane, GLint level, _Out_ void* pixels)
	{
		_getCompressedTexImage(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, pixels);
	}
	...
	static GLsizei getMaxCubeMapTextureSize()
	{
	...
	/*(1) Returns a two-dimensional cube map plane's texture image into client's memory. (2.1) Unbinds pixel pack buffer from its target
	@param Specifies the cube map plane to process
	@param Specifies the level-of-detail number of the desired image
	...
	void getTexImage(TextureCubeMapPlane plane, GLint level, GetTexFormat format, GetTexType type, _Out_ void* pixels)
	{
		_getTexImage(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, (GLenum)format, (GLenum)type, pixels);
	}
	...
	GLint getTextureAlphaSize(TextureCubeMapPlane plane, GLint level)
	{
		return _getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return _getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return _getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_BASE_LEVEL);
	}

	/*Returns a reference texture object currently bound to its target
	@return The reference texture object, or empty object*/
	static TextureCubeMap getTextureBinding()
	{
		return TextureCubeMap(_getInteger(GL_TEXTURE_BINDING_CUBE_MAP));
	}
	...
	GLint getTextureBlueSize(TextureCubeMapPlane plane, GLint level)
	{
		return _getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		return _getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		_getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		return (CompareFunc)_getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_COMPARE_FUNC);
	}
	...
	GLboolean getTextureCompressed(TextureCubeMapPlane plane, GLint level)
	{
		return _getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_COMPRESSED);
	}
	...
	{
		return _getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_COMPRESSED);
	}
	...
	GLsizei getTextureCompressedImageSize(TextureCubeMapPlane plane, GLint level)
	{
		return _getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	{
		return _getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_COMPRESSED_IMAGE_SIZE);
	}
	...
	GLint getTextureDepthSize(TextureCubeMapPlane plane, GLint level)
	{
		return _getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return _getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	GLint getTextureGreenSize(TextureCubeMapPlane plane, GLint level)
	{
		return _getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return _getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_GREEN_SIZE);
	}
	...
	GLsizei getTextureHeight(TextureCubeMapPlane plane, GLint level)
	{
		return _getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_HEIGHT);
	}
	...
	{
		return _getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_HEIGHT);
	}
	...
	TexInternalformat getTextureInternalFormat(TextureCubeMapPlane plane, GLint level)
	{
		return (TexInternalformat)_getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return (TexInternalformat)_getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return _getTexParameterFloat(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_LOD_BIAS);
	}
	...
	{
		return (TextureMagFilter)_getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MAG_FILTER);
	}
	...
	{
		return _getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MAX_LEVEL);
	}
	...
	{
		return _getTexParameterFloat(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MAX_LOD);
	}
	...
	{
		return (TextureMinFilter)_getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MIN_FILTER);
	}
	...
	{
		return _getTexParameterFloat(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MIN_LOD);
	}
	...
	GLint getTextureRedSize(TextureCubeMapPlane plane, GLint level)
	{
		return _getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return _getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_RED_SIZE);
	}
	...
	GLsizei getTextureWidth(TextureCubeMapPlane plane, GLint level)
	{
		return _getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_WIDTH);
	}
	...
	{
		return _getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_WIDTH);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_WRAP_R);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_WRAP_S);
	}
	...
	{
		return _isEnabled(GL_TEXTURE_CUBE_MAP);
	}
	...
	{
		return _object_id() == (GLuint)_getInteger(GL_TEXTURE_BINDING_CUBE_MAP);
	}

	/*Makes a reference of a texture object, regardless of the source object's reference flag
	@param Specifies the source texture object*/
	void referenceTexture(const TextureCubeMap& texture)
	{
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_BASE_LEVEL, level);
	}
	...
	{
		_texture_set(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, bind);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_COMPARE_FUNC, (GLint)func);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_LOD_BIAS, bias);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MAG_FILTER, (GLint)filter);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MAX_LEVEL, maxlevel);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MAX_LOD, maxlod);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MIN_FILTER, (GLint)filter);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_MIN_LOD, minlod);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_WRAP_R, (GLint)wrap);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_WRAP_S, (GLint)wrap);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_WRAP_T, (GLint)wrap);
	}

	/*(1) Specifies a two-dimensional cube map plane's texture image initialized from the StbImage object. (2.1) Unbinds pixel unpack buffer from its target
	@param Specifies the StbImage object with loaded image
	@param Specifies the cube map plane to process
	@param Specifies the level-of-detail number*/
	void texImage(StbImage& image, TextureCubeMapPlane plane, GLint level)
	{
		_texImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, _stbGetFormat(image), image);
	}

	/*(2) Specifies a two-dimensional cube map plane's texture image initialized from the StbImage object with specified texture internal format. (2.1) Unbinds pixel unpack buffer from its target
	@param Specifies the StbImage object with loaded image
	@param Specifies the cube map plane to process
	@param Specifies the level-of-detail number
	@param Specifies the texture internal formats*/
	void texImage(StbImage& image, TextureCubeMapPlane plane, GLint level, TexInternalformat internalformat)
	{
		_texImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, (GLint)internalformat, image);
	}

	/*(3) Specifies a two-dimensional cube map plane's texture image initialized from client's memory. (2.1) Unbinds pixel unpack buffer from its target
	@param Specifies the cube map plane to process
	@param Specifies the level-of-detail number
	@param Specifies the texture internal formats
	...
	void texImage(TextureCubeMapPlane plane, GLint level, TexInternalformat internalformat, GLsizei width, GLsizei height, TexFormat format, TexType type, _In_ const void* data)
	{
		_texImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, (GLint)internalformat, width, height, (GLenum)format, (GLenum)type, data);
	}
	...
	{
		_texImage2D(GL_PROXY_TEXTURE_CUBE_MAP, level, (GLint)internalformat, width, height, (GLenum)format, (GLenum)type, nullptr);
	}
	...
	@param Specifies a texel offset in the x direction within the texture array
	@param Specifies a texel offset in the y direction within the texture array*/
	void texSubImage(StbImage& image, TextureCubeMapPlane plane, GLint level, GLint xoffset, GLint yoffset)
	{
		_texSubImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, xoffset, yoffset, image);
	}

	/*(2) Specifies a two-dimensional cube map plane's texture subimage copied from client's memory data store. (2.1) Unbinds pixel unpack buffer from its target
	@param Specifies the cube map plane to process
	@param Specifies the level-of-detail number
	@param Specifies a texel offset in the x direction within the texture array
	@param Specifies a texel offset in the y direction within the texture array
	...
	@param Specifies the data type of the pixel data
	@param [in] Specifies a pointer to the image data in memory*/
	void texSubImage(TextureCubeMapPlane plane, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, TexSubFormat format, TexSubType type, _In_ const void* pixels)
	{
		_texSubImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, xoffset, yoffset, width, height, (GLenum)format, (GLenum)type, pixels);
	}

	/*Explicitly unbinds any texture object of specified type bound to its target. Does nothing if no such texture is bound*/
	static void unbindTarget()
	{
		_unbindTarget(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP);
	}

	/*Explicitly unbinds specified texture object from its target. Does nothing if specified texture is not bound*/
	void unbindTexture()
	{
		_unbindTexture(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP);
	}
	...
	void compressedTexImage(PixelUnpackBuffer& buffer, TextureCubeMapPlane plane, GLint level, CompressedTexInternalformat internalformat, GLsizei width, GLsizei height, GLsizei imageSize, GLintptr offset)
	{
		_compressedTexImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, (GLenum)internalformat, width, height, imageSize, (_Buffer&)buffer, offset);
	}
	...
	@param Specifies the number of unsigned bytes of image data starting at the specified data offset into PBO data store
	@param Specifies the byte offset into PBO data store*/
	void compressedTexSubImage(PixelUnpackBuffer& buffer, TextureCubeMapPlane plane, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, CompressedTexInternalformat internalformat, GLsizei imageSize, GLintptr offset)
	{
		_compressedTexSubImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, xoffset, yoffset, width, height, (GLenum)internalformat, imageSize, (_Buffer&)buffer, offset);
	}
	...
	@param Specifies the level-of-detail number of the desired image
	@param Specifies the byte offset into PBO data store*/
	void getCompressedTexImage(PixelPackBuffer& buffer, TextureCubeMapPlane plane, GLint level, GLintptr offset)
	{
		_getCompressedTexImage(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, (_Buffer&)buffer, offset);
	}
	...
	@param Specifies a pixel type for the returned data
	@param Specifies the byte offset into PBO data store*/
	void getTexImage(PixelPackBuffer& buffer, TextureCubeMapPlane plane, GLint level, GetTexFormat format, GetTexType type, GLintptr offset)
	{
		_getTexImage(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}
	...
	@param Specifies the data type of the pixel data
	@param Specifies the byte offset into PBO data store*/
	void texImage(PixelUnpackBuffer& buffer, TextureCubeMapPlane plane, GLint level, TexInternalformat internalformat, GLsizei width, GLsizei height, TexFormat format, TexType type, GLintptr offset)
	{
		_texImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, (GLint)internalformat, width, height, (GLenum)format, (_Buffer&)buffer, offset);
	}
	...
	@param Specifies the data type of the pixel data
	@param Specifies the byte offset into PBO data store*/
	void texSubImage(PixelUnpackBuffer& buffer, TextureCubeMapPlane plane, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, TexSubFormat format, TexSubType type, GLintptr offset)
	{
		_texSubImage2D(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, xoffset, yoffset, width, height, (GLenum)format, (GLenum)type, (_Buffer&)buffer, offset);
	}
	...
	void generateMipmap()
	{
		_generateMipmap(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP);
	}
	...
	TextureComponentType getTextureAlphaType(TextureCubeMapPlane plane, GLint level)
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	TextureComponentType getTextureBlueType(TextureCubeMapPlane plane, GLint level)
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return (TextureCompareMode)_getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_COMPARE_MODE);
	}
	...
	TextureComponentType getTextureDepthType(TextureCubeMapPlane plane, GLint level)
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	TextureComponentType getTextureGreenType(TextureCubeMapPlane plane, GLint level)
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_GREEN_TYPE);
	}
	...
	TextureComponentType getTextureRedType(TextureCubeMapPlane plane, GLint level)
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, (GLenum)plane, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_PROXY_TEXTURE_CUBE_MAP, level, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_COMPARE_MODE, (GLint)mode);
	}
	...
	static void disableTextureCubeMapSeamless()
	{
	...
	static void enableTextureCubeMapSeamless()
	{
	...
	static GLboolean isTextureCubeMapSeamless()
	{
	...
	{
		return (TextureSwizzleMask)_getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_A);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_B);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_G);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_R);
	}
	...
	{
		_getTexParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_RGBA, (GLint*)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_A, (GLint)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_B, (GLint)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_G, (GLint)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_R, (GLint)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_BINDING_CUBE_MAP, GL_TEXTURE_SWIZZLE_RGBA, (const GLint*)swizzle);
	}
...
/*Returns a reference TextureCubeMap object currently bound to its target
@return The reference TextureCubeMap object, or empty object*/
inline TextureCubeMap getTextureCubeMapBinding()
{
	return TextureCubeMap::getTextureBinding();
}

/*Explicitly unbinds any texture object of specified type bound to its target. Does nothing if no such texture is bound*/
inline void unbindTextureCubeMap()
{
	TextureCubeMap::unbindTarget();
}
} // namespace gl
