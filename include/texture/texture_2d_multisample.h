...
private:
	...
	Texture2DMultisample(GLint name) { _object_set(name); }
...
public:
	...
	Texture2DMultisample(const Texture2DMultisample& source)
	{
	...
	{
		_activeTexture(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, index);
	}
	...
	void duplicateTexture(const Texture2DMultisample& source)
	{
		_texture_dup((_Object&)source);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	static Texture2DMultisample getTextureBinding()
	{
		return Texture2DMultisample(_getInteger(GL_TEXTURE_BINDING_2D_MULTISAMPLE));
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		return (CompareFunc)_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_COMPARE_FUNC);
	}
	...
	{
		return (TextureCompareMode)_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_COMPARE_MODE);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_HEIGHT);
	}
	...
	{
		return (ColorDepthStencilFormat)_getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_DEPTH);
	}
	...
	{
		return (TextureMagFilter)_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_MAG_FILTER);
	}
	...
	{
		return (TextureMinFilter)_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_MIN_FILTER);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return (TextureComponentType)_getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		return _getTexLevelParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_WIDTH);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_WRAP_R);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_WRAP_S);
	}
	...
	{
		return (TextureWrapMode)_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_WRAP_T);
	}

	/*(3.2) Checks if the source texture object is referencing the same OpenGL object
	@param Specifies the source texture object
	@return True if duplicate object*/
	GLboolean isDuplicate(const Texture2DMultisample& source) const
	{
	...
	{
		return _object_binding(GL_TEXTURE_BINDING_2D_MULTISAMPLE);
	}

	/*(3.2) Creates a thread-safe reference object from the source texture object
	@param Specifies the source texture object*/
	void referTexture(const Texture2DMultisample& source)
	{
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_COMPARE_FUNC, (GLint)func);
	}
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_COMPARE_MODE, (GLint)mode);
	}
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_MAG_FILTER, (GLint)filter);
	}
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_MIN_FILTER, (GLint)filter);
	}
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_WRAP_R, (GLint)wrap);
	}
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_WRAP_S, (GLint)wrap);
	}
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_WRAP_T, (GLint)wrap);
	}
	...
	void texImage(GLsizei samples, ColorDepthStencilFormat internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations)
	{
		_texImage2DMultisample(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, samples, (GLenum)internalformat, width, height, fixedsamplelocations);
	}
	...
	@param The height of the multisample texture's image, in texels
	@param True if the image will use identical sample locations and the same number of samples for all texels in the image*/
	static void texImageProxy(GLsizei samples, ColorDepthStencilFormat internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations)
	{
	...
	{
		return (TextureSwizzleMask)_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_A);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_B);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_G);
	}
	...
	{
		return (TextureSwizzleMask)_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_R);
	}
	...
	{
		_getTexParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_RGBA, (GLint*)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_A, (GLint)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_B, (GLint)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_G, (GLint)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_R, (GLint)swizzle);
	}
	...
	{
		_texParameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_RGBA, (const GLint*)swizzle);
	}
...
/*(3.2) Returns a reference Texture2DMultisample object currently bound to its target
@return The reference Texture2DMultisample object, or empty object*/
inline Texture2DMultisample getTexture2DMultisampleBinding()
{
	return Texture2DMultisample::getTextureBinding();
}

/*(3.2) Explicitly unbinds any texture object of specified type bound to its target. Does nothing if no such texture is bound*/
inline void unbindTexture2DMultisample()
{
	Texture2DMultisample::unbindTarget();
}
} // namespace gl
