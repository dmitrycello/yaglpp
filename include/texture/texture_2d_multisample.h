...
#ifndef YAGLPP_TEXTURE_2D_MULTISAMPLE_H
#define YAGLPP_TEXTURE_2D_MULTISAMPLE_H

#ifdef YAGLPP_VERSION_3_2
namespace gl {
/*(3.2) OpenGL two-dimensional multisample texture object class derived from <Textures>*/
class Texture2DMultisample : public Textures
{
public:
	...
	void Bind()
	{
		object_bind(glBindTexture, GL_TEXTURE_2D_MULTISAMPLE);
	}

	/*(3.2) Generates OpenGL texture object name in an empty texture class object, and bind it to its target in one function call*/
	void GenBind()
	{
		object_gen_bind(glGenTextures, glBindTexture, GL_TEXTURE_2D_MULTISAMPLE);
	}
	...
	GLuint GetAlphaSize()
	{
		return get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	GLuint GetBlueSize()
	{
		return get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		return (CompareFunc)get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_COMPARE_FUNC);
	}
	...
	{
		return (CompareMode)get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_COMPARE_MODE);
	}
	...
	GLuint GetDepthSize()
	{
		return get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	GLuint GetGreenSize()
	{
		return get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_GREEN_TYPE);
	}
	...
	GLsizei GetHeight()
	{
		return get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_HEIGHT);
	}
	...
	{
		return (ColorDepthStencil)get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return (MagFilter)get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_MAG_FILTER);
	}
	...
	{
		return (MinFilter)get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_MIN_FILTER);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_ALPHA_SIZE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_ALPHA_TYPE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_BLUE_SIZE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_BLUE_TYPE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_DEPTH_SIZE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_DEPTH_TYPE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_GREEN_SIZE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_GREEN_TYPE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_HEIGHT);
	}
	...
	{
		return (ColorDepthStencil)get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_INTERNAL_FORMAT);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return (ComponentType)get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_RED_TYPE);
	}
	...
	{
		return get_proxy_level_parameter(GL_PROXY_TEXTURE_2D_MULTISAMPLE, 0, GL_TEXTURE_WIDTH);
	}
	...
	GLuint GetRedSize()
	{
		return get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_RED_SIZE);
	}
	...
	{
		return (ComponentType)get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_RED_TYPE);
	}
	...
	GLsizei GetWidth()
	{
		return get_tex_level_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, 0, GL_TEXTURE_WIDTH);
	}
	...
	WrapMode GetWrapR()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_WRAP_R);
	}
	...
	WrapMode GetWrapS()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_WRAP_S);
	}
	...
	WrapMode GetWrapT()
	{
		return (WrapMode)get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_WRAP_T);
	}
	...
	{
		return object_binding(GL_TEXTURE_BINDING_2D_MULTISAMPLE, Get());
	}
	...
	{
		proxy_image_2d_multisample(GL_PROXY_TEXTURE_2D_MULTISAMPLE_ARRAY, samples, (GLenum)internalformat, width, height, fixedsamplelocations);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_BORDER_COLOR, color);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_COMPARE_FUNC, (GLint)func);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_COMPARE_MODE, (GLint)mode);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_MAG_FILTER, (GLint)filter);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_MIN_FILTER, (GLint)filter);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_WRAP_R, (GLint)wrap);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_WRAP_S, (GLint)wrap);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_WRAP_T, (GLint)wrap);
	}
	...
	/*(3.2) Read-only property for state of the texture binding*/
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_A);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_B);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_G);
	}
	...
	{
		return (SwizzleMask)get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_R);
	}
	...
	{
		get_tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_RGBA, (GLint*)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_A, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_B, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_G, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_R, (GLint)swizzle);
	}
	...
	{
		tex_parameter(GL_TEXTURE_2D_MULTISAMPLE, GL_TEXTURE_BINDING_2D_MULTISAMPLE, GL_TEXTURE_SWIZZLE_RGBA, (const GLint*)swizzle);
	}
...
#endif // #ifndef YAGLPP_TEXTURE_2D_MULTISAMPLE_H
