...
> [!NOTE]
> Not every glpp object follows this roule: **`gl::VertexArray`** and **`gl::Sampler`** objects must be binded explicitly, where as **`glfw::Window`** and **`glfw::Thread`** objects have to be created with specific parameters.
