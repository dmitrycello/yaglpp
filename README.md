...
The OpenGL  do not have dynamic allocation or clearing functions. The Program object must to be explicitly _linked_, where as the Shader object must be explicitly _compiled_, the appropriate constructors exist as well:
