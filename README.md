...
> [!NOTE]
> This library does not have any updates since 2015, besides it has only DLL version, which requires the library DLL file destribution. Therefore, it could be excluded from the YAGL++ build by commenting the **`YAGLPP_FREEIMAGE_LIB`** switch.
