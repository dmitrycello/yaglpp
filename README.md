...
> [!NOTE]
> Not every glpp object follows this roule: **`gl::VertexArray`** and **`gl::Sampler`** objects must be binded explicitly, where as all multi-objects and **`glfw::`** objects have to be created with specified parameters.
