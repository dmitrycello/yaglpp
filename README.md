...
- It impliments the [SAL](https://learn.microsoft.com/en-us/cpp/code-quality/using-sal-annotations-to-reduce-c-cpp-code-defects) concept (Microsoft Source Code Annotation Language), making the usage of the library less error-prone. The SAL macros are silently ignored while being in non-MSVC environment;
