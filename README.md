# glpp: OpenGL C++ extension library
	...
	+-----------------------------------------------+
	|   glpp: OpenGL C++ extension library 24.4.2   |
	+-----------------------------------------------+

	This project is an attempt to develop a C++ OpenGL library mainly to help
	learning GLAD/GLFW API, but it may also be used as an efficient tool,
	allowing to develop the OpenGL applications in less complicated manner with
	...
	attempts to impliment the inline calls, depending on the compiler setting.
