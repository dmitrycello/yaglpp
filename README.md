...
2. <ins>Prepare the OpenGL component folder</ins>. Create the new folder anywhere on your PC, and name it **`Common`**. Extract all downloaded OpenGL components, and move them into its following subdirectories:
```
