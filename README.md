...
> [!TIP]
> In order to change these switches, it is necessary to add other versions of the GLAD header file to **`glad`** folder, as described in [this section](docs/INSTALLATION.md#4-earlier-glad-versionss).
