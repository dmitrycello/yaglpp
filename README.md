...
> [!NOTE]
> Not all glpp objects follow this roule. The **`gl::VertexArray`** (VAO) and **`gl::Sampler`** objects must be binded explicitly, where as **`glfw::Window`** and **`glfw::Thread`** objects have to be created with specific parameters.
